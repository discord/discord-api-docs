...
This repo contains the official Discord for Developers documentation, which can be viewed online [HERE](https://docs.discord.com/developers/intro). Before submitting pull-requests, please remember to _fully_ read the [Contributing](CONTRIBUTING.md) guidelines.
...
```
http://localhost:3000/developers/intro
```
