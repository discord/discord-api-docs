...
<YouTubeEmbed
  src="https://www.youtube.com/embed/CtrDTDI8afc"
  title="Slash Commands and Friends"
  showDuration
  chapters={`0:00 Introduction to Bot Development and Interactions
1:33 Host Introductions
2:29 Overview of Interactions: Gateway vs. HTTP
4:14 Interaction Examples: Slash Commands, Buttons, Modals, and Context Menus
7:18 Gateway vs. HTTP Deep Dive
8:09 Interactions Endpoint URL Configuration
11:30 Coding a Web Server and Verifying Key Handshakes
12:56 Handling Interaction Types and Responding to Pings
22:46 Bot Online Status and Interaction URL Behavior
23:25 Command Registration Basics (Global vs. Guild Commands)
25:52 Command Options and Configuration Types
27:00 Handling Application Commands and Checking Data Names
33:34 Managing the 3-Second Interaction Timeout Response
36:16 Creating and Registering the Weather Command with Options
40:46 Drawing the Weather UI and Managing Stateless State
46:44 Simulating API Latency and Using Deferred Responses
51:33 Implementing Autocomplete for Command Options
54:54 Handling Message Component Events and Storing Button State
57:20 Updating Existing Messages with New Data
1:00:12 Launching Modals for Alerts
1:02:43 Interaction Token Expiration and Session Management
1:04:10 Accessing GitHub Repositories and Tutorial Resources
1:05:16 Q&A: Privileged Intents, Slash Commands, and Team Ownership
1:07:29 Closing Out`}
/>
...
| description                | string                                                                                                                                     | Description for `CHAT_INPUT` and `PRIMARY_ENTRY_POINT` commands, 1-100 characters. Empty string for `USER` and `MESSAGE` commands                                                                                                                                          | all                 |
...
| options? \*                | array of [command options](/developers/interactions/application-commands#application-command-object-application-command-option-structure)  | Parameters for the command, max of 25                                                                                                                                                                                                                                      | CHAT_INPUT          |
...
| handler?                   | one of [command handler types](/developers/interactions/application-commands#application-command-object-entry-point-command-handler-types) | Determines whether the interaction is handled by the app's interactions handler or by Discord                                                                                                                                                                              | PRIMARY_ENTRY_POINT |
...
| PRIMARY_ENTRY_POINT | 4    | A UI-based command that represents the primary way to invoke an app's [Activity](/developers/activities/overview) |
...
<Route method="GET">/applications/[\{application.id\}](/developers/resources/application#application-object)/commands</Route>
...
| Field               | Type                                                   | Description                                                                                                                                                                                                            |
|---------------------|--------------------------------------------------------|------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| with_localizations? | [boolean](/developers/reference#boolean-query-strings) | Whether to include full localization dictionaries (`name_localizations` and `description_localizations`) in the returned objects, instead of the `name_localized` and `description_localized` fields. Default `false`. |

## Create Global Application Command
<Route method="POST">/applications/[\{application.id\}](/developers/resources/application#application-object)/commands</Route>
...
| name_localizations?         | ?dictionary with keys in [available locales](/developers/reference#locales)                                                                            | Localization dictionary for the `name` field. Values follow the same restrictions as `name`                                                                                             |
| description?                | string                                                                                                                                                 | 1-100 character description for `CHAT_INPUT` and `PRIMARY_ENTRY_POINT` commands                                                                                                         |
| description_localizations?  | ?dictionary with keys in [available locales](/developers/reference#locales)                                                                            | Localization dictionary for the `description` field. Values follow the same restrictions as `description`                                                                               |
...
| default_member_permissions? | ?string                                                                                                                                                | Set of [permissions](/developers/topics/permissions) represented as a bit set                                                                                                           |
...
| integration_types?          | list of [integration types](/developers/resources/application#application-object-application-integration-types)                                        | [Installation context(s)](/developers/resources/application#installation-context) where the command is available                                                                        |
...
<Route method="GET">/applications/[\{application.id\}](/developers/resources/application#application-object)/commands/[\{command.id\}](/developers/interactions/application-commands#application-command-object)</Route>
...
<Route method="PATCH">/applications/[\{application.id\}](/developers/resources/application#application-object)/commands/[\{command.id\}](/developers/interactions/application-commands#application-command-object)</Route>
...
<Route method="DELETE">/applications/[\{application.id\}](/developers/resources/application#application-object)/commands/[\{command.id\}](/developers/interactions/application-commands#application-command-object)</Route>

Deletes a global command. Returns `204 No Content` on success.

## Bulk Overwrite Global Application Commands
<Route method="PUT">/applications/[\{application.id\}](/developers/resources/application#application-object)/commands</Route>
...
<Route method="GET">/applications/[\{application.id\}](/developers/resources/application#application-object)/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/commands</Route>
...
<Route method="POST">/applications/[\{application.id\}](/developers/resources/application#application-object)/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/commands</Route>
...
<Route method="GET">/applications/[\{application.id\}](/developers/resources/application#application-object)/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/commands/[\{command.id\}](/developers/interactions/application-commands#application-command-object)</Route>
...
<Route method="PATCH">/applications/[\{application.id\}](/developers/resources/application#application-object)/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/commands/[\{command.id\}](/developers/interactions/application-commands#application-command-object)</Route>
...
<Route method="DELETE">/applications/[\{application.id\}](/developers/resources/application#application-object)/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/commands/[\{command.id\}](/developers/interactions/application-commands#application-command-object)</Route>

Delete a guild command. Returns `204 No Content` on success.

## Bulk Overwrite Guild Application Commands
<Route method="PUT">/applications/[\{application.id\}](/developers/resources/application#application-object)/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/commands</Route>
...
| dm_permission?              | ?boolean                                                                                                                                             | **Deprecated (use `contexts` instead)**; Indicates whether the command is available in DMs with the app, only for globally-scoped commands. By default, commands are visible.              |
| default_permission?         | boolean                                                                                                                                              | Replaced by `default_member_permissions` and will be deprecated in the future. Indicates whether the command is enabled by default when the app is added to a guild. Defaults to `true`    |
| integration_types           | list of [integration types](/developers/resources/application#application-object-application-integration-types)                                      | [Installation context(s)](/developers/resources/application#installation-context) where the command is available, defaults to `GUILD_INSTALL` (`[0]`)                                      |
...
<Route method="GET">/applications/[\{application.id\}](/developers/resources/application#application-object)/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/commands/permissions</Route>
...
<Route method="GET">/applications/[\{application.id\}](/developers/resources/application#application-object)/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/commands/[\{command.id\}](/developers/interactions/application-commands#application-command-object)/permissions</Route>
...
<Route method="PUT">/applications/[\{application.id\}](/developers/resources/application#application-object)/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/commands/[\{command.id\}](/developers/interactions/application-commands#application-command-object)/permissions</Route>
...
<Route method="PUT">/applications/[\{application.id\}](/developers/resources/application#application-object)/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/commands/permissions</Route>
