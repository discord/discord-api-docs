...
| target_user?                | [user](/developers/resources/user#user-object) object                                                    | the user whose stream to display for this voice channel stream invite                                              |
| target_application?         | partial [application](/developers/resources/application#application-object) object                       | the embedded application to open for this voice channel embedded application invite                                |
...
| guild_scheduled_event?      | [guild scheduled event](/developers/resources/guild-scheduled-event#guild-scheduled-event-object) object | guild scheduled event data, only included if `guild_scheduled_event_id` contains a valid guild scheduled event id  |
...
| Field                     | Type                                                   | Description                                                 |
|---------------------------|--------------------------------------------------------|-------------------------------------------------------------|
| with_counts?              | [boolean](/developers/reference#boolean-query-strings) | whether the invite should contain approximate member counts |
...
## Add Target User
<Route method="PUT">/invites/[\{invite.code\}](/developers/resources/invite#invite-object)/target-users/[\{user.id\}](/developers/resources/user#user-object)</Route>
...
## Remove Target User
<Route method="DELETE">/invites/[\{invite.code\}](/developers/resources/invite#invite-object)/target-users/[\{user.id\}](/developers/resources/user#user-object)</Route>
...
<Route method="POST">/invites/[\{invite.code\}](/developers/resources/invite#invite-object)/target-users/bulk-add</Route>
...
<ManualAnchor id="bulk-add-target-users-json-params" />
###### JSON Params

| Field    | Type                | Description                                |
|----------|---------------------|--------------------------------------------|
| user_ids | array of snowflakes | the IDs of users to add, max of 1000 users |

## Bulk-Delete Target Users
<Route method="POST">/invites/[\{invite.code\}](/developers/resources/invite#invite-object)/target-users/bulk-delete</Route>
...
<ManualAnchor id="bulk-delete-target-users-json-params" />
###### JSON Params

| Field    | Type                | Description                                   |
|----------|---------------------|-----------------------------------------------|
| user_ids | array of snowflakes | the IDs of users to remove, max of 1000 users |
