...
<<<<<<< HEAD:developers/resources/invite.mdx
...
| roles?                      | array of partial [role](/developers/topics/permissions#role-object) objects                              | the roles assigned to the user upon accepting the invite. Contains a limited amount of [role](/developers/topics/permissions#role-object) information |
=======
| Field                       | Type                                                                                               | Description                                                                                                        |
|-----------------------------|----------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------|
...
| roles?\*                    | array of partial [role](/docs/topics/permissions#role-object) objects                              | the roles assigned to the user upon accepting the invite.                                                          |

\* This is a partial role object that only contains `id`, `name`, `position`, `color`, `colors`, `icon`, and `unicode_emoji`.
>>>>>>> 4898526c (Add more details):docs/resources/invite.mdx
