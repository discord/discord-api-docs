...
| format_type | integer                                               | [type of sticker format](/developers/resources/sticker#sticker-object-sticker-format-types) |
...
| banner_asset_id?  | snowflake                                                                | id of the sticker pack's [banner image](/developers/reference#image-formatting) |
...
| Field         | Type                                                                               |
|---------------|------------------------------------------------------------------------------------|
| sticker_packs | array of [sticker pack](/developers/resources/sticker#sticker-pack-object) objects |
...
Create a new sticker for the guild. Send a `multipart/form-data` body as described in [Uploading Files](/developers/reference#uploading-files). Requires the `CREATE_GUILD_EXPRESSIONS` permission. Returns the new [sticker](/developers/resources/sticker#sticker-object) object on success. Fires a [Guild Stickers Update](/developers/events/gateway-events#guild-stickers-update) Gateway event.
