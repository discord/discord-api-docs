...
| new_member_actions | array of [new memeber action](/developers/resources/guild#guild-home-settings-object-new-member-action-structure) objects | the actions that new members are prompted to complete         |
...
Returns the [Home Settings](/developers/resources/guild#guild-onboarding-object) object for the guild.