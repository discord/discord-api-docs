...
<Warning>
Starting October 12, 2026, this endpoint will omit any channel your bot doesn't have `VIEW_CHANNEL` permission for, see [Channel Obfuscation for Bots](/developers/change-log#channel-obfuscation-for-bots).
</Warning>
