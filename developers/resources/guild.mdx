...
Returns a list of guild [channel](/developers/resources/channel#channel-object) objects. Does not include threads. Starting October 12, 2026, this endpoint will omit any channel your app doesn't have `VIEW_CHANNEL` permission for; see [Channel Obfuscation for Bots](/developers/change-log#channel-obfuscation-for-bots).
