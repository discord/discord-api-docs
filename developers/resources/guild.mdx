...
| display_name_styles?          | ?[display name styles](/developers/resources/user#display-name-styles-object-display-name-styles-structure) object | styles applied to the member's display (or nick) name                                                                                                                                                                                |
...
| display_name_font_id?   | ?integer        | the [font](/developers/resources/user#display-name-styles-object-display-name-font) of the member's display name        |                 |
| display_name_effect_id? | ?integer        | the [effect](/developers/resources/user#display-name-styles-object-display-name-effect) of the member's display name    |                 |
| display_name_colors?    | ?array[integer] | the colors of the member's display name encoded as an array of integers representing hexadecimal color codes (max 2)    |                 |
