...
<Warning>
Starting October 12, 2026, this endpoint will omit any channel your bot doesn't have permissions to view. Permission to view a channel is defined by having `VIEW_CHANNEL` permission on a channel or by being connected to a voice channel. Channel categories are viewable if any of their children channels are viewable. See [Channel Obfuscation for Users and Bots](/developers/change-log#channel-obfuscation-for-users-and-bots) for more information.
</Warning>
