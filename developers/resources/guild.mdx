...
| MEMBER_VERIFICATION_MANUAL_APPROVAL       | guild requires manual approval of [join requests](/developers/resources/guild-join-request) to join                                 |
...
Guilds with the `MEMBER_VERIFICATION_MANUAL_APPROVAL` [feature](/developers/resources/guild#guild-object-guild-features) additionally require a moderator to review each applicant. See the [Guild Join Request](/developers/resources/guild-join-request) resource for the objects, endpoints, and Gateway events used to review those applications.
