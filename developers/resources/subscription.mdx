...
<Route method="GET">/skus/[\{sku.id\}](/developers/resources/sku#sku-object)/subscriptions</Route>
...
<Route method="GET">/skus/[\{sku.id\}](/developers/resources/sku#sku-object)/subscriptions/[\{subscription.id\}](/developers/resources/subscription#subscription-object)</Route>
