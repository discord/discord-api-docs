...
<Info>
`id`, `type`, and `position` are not redacted, even on an obfuscated channel your app can rely on their real values. Most other fields are redacted and should not be relied on.
</Info>
