...
| target_users_file?\*  | file                | a csv file with a single column of user IDs for all the users able to accept this invite. Max of 1000 IDs                                 |                  |
| target_user_ids?\*\*  | array of snowflakes | an array of IDs of all users able to see and accept this invite                                                                           |                  |
