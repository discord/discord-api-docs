...
| Field                         | Type                                                            | Description                                                       |
|-------------------------------|-----------------------------------------------------------------|-------------------------------------------------------------------|
| original_scheduled_start_time | [ISO8601 timestamp](/developers/reference#iso8601-date%2Ftime)  | the original time at when the scheduled event would've started    |
...
Delete an exception for the guild scheduled event's recurrence rule. Fires a [Guild Scheduled Event Exception Delete](/developers/events/gateway-events#guild-scheduled-event-exception-delete) Gateway event.
...
<Route method="GET">/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/scheduled-events/[\{guild_scheduled_event.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-object)/[\{guild_scheduled_event_exception.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-exception-object)/users</Route>
