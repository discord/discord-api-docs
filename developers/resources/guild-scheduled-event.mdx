...
| by_weekday        | ?array of [recurrence rule - weekday](/developers/resources/guild-scheduled-event#guild-scheduled-event-recurrence-rule-object-guild-scheduled-event-recurrence-rule-weekday)                      | Set of specific days within a week for the event to recur on                                                                                      |
| by_n_weekday      | ?array of [recurrence rule - n_weekday](/developers/resources/guild-scheduled-event#guild-scheduled-event-recurrence-rule-object-guild-scheduled-event-recurrence-rule-nweekday-structure) objects | List of specific days within a specific week (1-5) to recur on                                                                                    |
| by_month          | ?array of [recurrence rule - month](/developers/resources/guild-scheduled-event#guild-scheduled-event-recurrence-rule-object-guild-scheduled-event-recurrence-rule-month)                          | Set of specific months to recur on                                                                                                                |
...
A guild scheduled event exception represents a skipped or rescheduled recurrence for the scheduled event's [recurrence rule](/developers/resources/guild-scheduled-event#guild-scheduled-event-recurrence-rule-object). In the client, scheduled event exceptions are commonly highlighted as events that have had specific recurrences canceled or re-scheduled.

While the API uses the `_exception_id` naming convention, these fields additionally function as recurrence IDs. This means that these IDs are valid regardless of whether an exception has been created for that specific recurrence.

A recurrence ID is the start time of a specific scheduled event recurrence, serialized as a snowflake. A recurrence ID is valid if its timestamp component corresponds to a recurrence for the scheduled event's recurrence rule.

<Info>
For the sake of readability, `event_exception_id` is referred to as `exception.id` when used in an endpoint path.
</Info>

<ManualAnchor id="guild-scheduled-event-exception-object-guild-scheduled-event-exception-structure" />
###### Guild Scheduled Event Exception Structure

| Field                      | Type                                                            | Description                                                                                |
|----------------------------|-----------------------------------------------------------------|--------------------------------------------------------------------------------------------|
| event_id                   | snowflake                                                       | the id of the scheduled event the exception belongs to                                     |
| event_exception_id \[1\]   | snowflake                                                       | a snowflake containing the original scheduled start time of the scheduled event recurrence |
| scheduled_start_time \[2\] | ?[ISO8601 timestamp](/developers/reference#iso8601-date%2Ftime) | the new time at when the scheduled event recurrence will start, if applicable              |
| scheduled_end_time \[2\]   | ?[ISO8601 timestamp](/developers/reference#iso8601-date%2Ftime) | the new time at when the scheduled event recurrence will end, if applicable                |
| is_canceled \[2\]          | boolean                                                         | whether or not the scheduled event will be skipped on the recurrence                       |

\[1\] The snowflake in this field is not guaranteed to be globally unique.

\[2\] When `is_canceled` is true, the recurrence will be skipped regardless of whether `scheduled_start_time` or `scheduled_end_time` are set.
...
| Field            | Type                                                   | Description                                      |
|------------------|--------------------------------------------------------|--------------------------------------------------|
| with_user_count? | [boolean](/developers/reference#boolean-query-strings) | include number of users subscribed to each event |
...
| entity_metadata? **    | [entity metadata](/developers/resources/guild-scheduled-event#guild-scheduled-event-object-guild-scheduled-event-entity-metadata) | the entity metadata of the scheduled event            |
...
| entity_type            | [entity type](/developers/resources/guild-scheduled-event#guild-scheduled-event-object-guild-scheduled-event-entity-types)        | the entity type of the scheduled event                |
...
<Route method="GET">/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/scheduled-events/[\{guild_scheduled_event.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-object)</Route>
...
| Field            | Type                                                   | Description                                      |
|------------------|--------------------------------------------------------|--------------------------------------------------|
| with_user_count? | [boolean](/developers/reference#boolean-query-strings) | include number of users subscribed to this event |

## Modify Guild Scheduled Event
<Route method="PATCH">/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/scheduled-events/[\{guild_scheduled_event.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-object)</Route>
...
<Info>
Modifying the `recurrence_rule` may cause all exceptions for an event to be deleted.
</Info>
...
| scheduled_end_time? * | ISO8601 timestamp                                                                                                                  | the time when the scheduled event is scheduled to end                                      |
| description?          | ?string                                                                                                                            | the description of the scheduled event                                                     |
| entity_type? *        | [event entity type](/developers/resources/guild-scheduled-event#guild-scheduled-event-object-guild-scheduled-event-entity-types)   | the entity type of the scheduled event                                                     |
| status?               | [event status](/developers/resources/guild-scheduled-event#guild-scheduled-event-object-guild-scheduled-event-status)              | the status of the scheduled event                                                          |
| image?                | [image data](/developers/reference#image-data)                                                                                     | the cover image of the scheduled event                                                     |
| recurrence_rule?      | ?[recurrence rule](/developers/resources/guild-scheduled-event#guild-scheduled-event-recurrence-rule-object)                       | the definition for how often this event should recur                                       |
...
<Route method="DELETE">/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/scheduled-events/[\{guild_scheduled_event.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-object)</Route>
...
<Route method="GET">/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/scheduled-events/[\{guild_scheduled_event.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-object)/users</Route>
...
<Route method="POST">/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/scheduled-events/[\{guild_scheduled_event.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-object)/exceptions</Route>

Creates an exception to the recurrence rule for a guild scheduled event. Returns the created [guild scheduled event exception object](/developers/resources/guild-scheduled-event#guild-scheduled-event-exception-object) on success. Fires a [Guild Scheduled Event Exception Create](/developers/events/gateway-events#guild-scheduled-event-exception-create) Gateway event.
...
| Field                         | Type                                                            | Description                                                               |
|-------------------------------|-----------------------------------------------------------------|---------------------------------------------------------------------------|
| original_scheduled_start_time | [ISO8601 timestamp](/developers/reference#iso8601-date%2Ftime)  | the original time at when the scheduled event recurrence would've started |
| scheduled_start_time?         | ?[ISO8601 timestamp](/developers/reference#iso8601-date%2Ftime) | the modified start time for the scheduled event recurrence                |
| scheduled_end_time?           | ?[ISO8601 timestamp](/developers/reference#iso8601-date%2Ftime) | the modified end time for the scheduled event recurrence                  |
...
<Route method="PATCH">/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/scheduled-events/[\{guild_scheduled_event.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-object)/exceptions/[\{exception.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-exception-object)</Route>

Modify an exception to the recurrence rule for a guild scheduled event. Returns the updated [guild scheduled event exception object](/developers/resources/guild-scheduled-event#guild-scheduled-event-exception-object) on success. Fires a [Guild Scheduled Event Exception Update](/developers/events/gateway-events#guild-scheduled-event-exception-update) Gateway event.
...
<Route method="DELETE">/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/scheduled-events/[\{guild_scheduled_event.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-object)/exceptions/[\{exception.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-exception-object)</Route>

Delete an exception to the recurrence rule for a guild scheduled event. Fires a [Guild Scheduled Event Exception Delete](/developers/events/gateway-events#guild-scheduled-event-exception-delete) Gateway event.
...
<Route method="GET">/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/scheduled-events/[\{guild_scheduled_event.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-object)/[\{exception.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-exception-object)/users</Route>
...
<ManualAnchor id="get-guild-scheduled-event-exception-users-query-string-params" />
###### Query String Params
...
## Get Guild Scheduled Event User Counts
<Route method="GET">/guilds/[\{guild.id\}](/developers/resources/guild#guild-object)/scheduled-events/[\{guild_scheduled_event.id\}](/developers/resources/guild-scheduled-event#guild-scheduled-event-object)/users/counts</Route>
...
<ManualAnchor id="get-guild-scheduled-event-user-counts-query-string-params" />
###### Query String Params

| Field                                | Type                                                             | Description                                                                               |
|--------------------------------------|------------------------------------------------------------------|-------------------------------------------------------------------------------------------|
| guild_scheduled_event_exception_ids? | [array](/developers/reference#array-query-strings) of snowflakes | the ids of the guild scheduled event exceptions to return user counts for (maximum of 10) |
