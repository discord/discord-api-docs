...
\* The snowflake in this field is not guaranteed to be globally unique.
...
<Note>
All parameters to this endpoint are optional. Omitting or setting a null value will set it to default.
</Note>
