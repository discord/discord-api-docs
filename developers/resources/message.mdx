...
| attachments \[2\]         | array of [attachment](/developers/resources/message#attachment-object) objects                                                           | any attached files                                                                                                                                                                                                                                                      |
...
| thumbnail?   | [embed thumbnail](/developers/resources/message#embed-object-embed-thumbnail-structure) object   | thumbnail information                                                                                      |
...
<ManualAnchor id="embed-object-embed-thumbnail-structure" />
...
| sort_by? \[1\]        | string              | The [sorting algorithm](/developers/resources/message#search-guild-messages-search-sort-types) to use                               |
...
| gif \[1\] | Return messages that have a gif embed      |
...
<ManualAnchor id="search-guild-messages-search-sort-types" />
###### Search Sort Types
