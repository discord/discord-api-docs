...
| attachments \[2\]         | array of [attachment](/developers/resources/message#attachment-object) objects                                                           | any attached files, this will be empty if the message has the `IS_COMPONENTS_V2` flag (`1 << 15`) set and attachments will instead be included within the `components` field                                                                                            |
