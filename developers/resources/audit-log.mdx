...
| event_exception_id                | snowflake | ID of the guild scheduled event exception that was targeted      | GUILD_SCHEDULED_EVENT_EXCEPTION_CREATE & GUILD_SCHEDULED_EVENT_EXCEPTION_UPDATE & GUILD_SCHEDULED_EVENT_EXCEPTION_DELETE                                                                                                                                                                                                                         |
