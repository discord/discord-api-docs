...
\* In the case of endpoints that support GIFs, the hash will begin with `a_` if it is available in an animated format. These images can be retrieved as animated WebP using the `?animated=true` querystring parameter. (example: `a_1269e74af4df7417b13759eae50c83dc`)
