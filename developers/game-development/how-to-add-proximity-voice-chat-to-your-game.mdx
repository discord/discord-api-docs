...
<YouTubeEmbed
        src="https://www.youtube.com/embed/HzmJqaBoge4"
        title="Proximity Voice Chat in Unity with the Discord Social SDK"
        showDuration
        chapters={`0:00 Stream Start!
1:06 Welcome Anthony and Meka!
4:16 Intro to Proximity Voice Chat
10:19 Unity + Discord Social SDK Overview
17:14 Demo - Adding Proximity Voice Chat to Your Unity Project
1:26:10 Wrapping up!`}
/>
