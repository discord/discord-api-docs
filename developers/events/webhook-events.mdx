...
The inner payload is a [message object](/developers/events/webhook-events#message-object) or [passthrough message object](/developers/events/webhook-events#passthrough-message-object).
...
- [Passthrough messages](/developers/events/webhook-events#passthrough-message-object) are used for communication between provisional accounts
