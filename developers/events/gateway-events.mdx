...
| guilds             | array of [Unavailable Guild](/developers/resources/guild#unavailable-guild-object) objects | Guilds the user is in. For sharding, guilds expected for that shard                                             |
