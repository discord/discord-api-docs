...
<CardGroup cols={3}>
  <Card title="Gateway Events" href="/developers/events/gateway">
    Gateway is the primary apps receive events on Discord. Read details about using the Gateway and receiving Gateway Events.
  </Card>
  <Card title="Webhook Events" href="/developers/events/webhook-events">
    Read details about receiving and responding a small number of HTTP-based Webhook Events.
  </Card>
  <Card title="Embedded App SDK Events" href="/developers/developer-tools/embedded-app-sdk#sdk-events">
