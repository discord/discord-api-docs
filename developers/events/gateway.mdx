...
Apps can also opt into a [gateway capability](/developers/events/gateway-events#identify-gateway-capabilities) in the Identify payload that changes how existing gateway behaviors work.
