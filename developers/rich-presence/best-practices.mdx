...
If you don't already know about Rich Presence, read [the overview](/developers/rich-presence/overview) first.
...
<Info>
Since all Activities presence data has an **Ask to Join** button, Join Invites are only applicable when building with the [Game SDK](/developers/rich-presence/using-with-the-game-sdk)
</Info>
