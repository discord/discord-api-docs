...
- The **[Game SDK (legacy)](/developers/rich-presence/overview#game-sdk)** can be used if you're building an off-platform game or app and you want to integrate it into Discord.
...
[Read about using Rich Presence with the Discord Social SDK](/developers/rich-presence/using-with-the-discord-social-sdk)
...
The [Game SDK](/developers/developer-tools/game-sdk) makes it easier to build 3rd party games and integrate them with Discord. While many features of the Game SDK are deprecated, it can still be used for a few use cases (like integrating Rich Presence!).
...
[Read about using Rich Presence with the Game SDK](/developers/rich-presence/using-with-the-game-sdk)
...
The Rich Presence invite image appears when [invites](/developers/developer-tools/game-sdk#sendinvite) are sent for a 3rd party game or app using the [Game SDK](/developers/rich-presence/overview#game-sdk). After uploading an invite image for your app, you can see a preview of it to the right (under "IRL Invite Image Example").

<Info>
The invite image can be ignored if you're building using the [Embedded App SDK](/developers/rich-presence/overview#embedded-app-sdk). Invites sent using the Embedded App SDK's[`openInviteDialog()`](/developers/developer-tools/embedded-app-sdk#openinvitedialog) use the Activity's cover art.
</Info>
...
<CardGroup cols={3}>
  ...
  <Card title="Using Rich Presence with the Game SDK" href="/developers/rich-presence/using-with-the-game-sdk">
