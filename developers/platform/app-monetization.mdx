...
Both types integrate through the same [SKU](/developers/resource/sku) and [Entitlement](/developers/resource/entitlement) APIs, so your app checks whether a user is entitled to a feature before granting access.
