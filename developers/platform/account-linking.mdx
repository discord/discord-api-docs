...
When they later link a Discord account, their friends, DM history, and lobby memberships transfer automatically. Learn more in the [Provisional Accounts guide](/developers/discord-social-sdk/development-guides/provisional-accounts/overview).

## Next Steps

<YouTubeEmbed
        src="https://www.youtube.com/embed/3ItP16np9SE"
        title="Building Deeper Player Connections with Discord Account Linking | 2026 GDC Discord Booth Talk"
        showDuration
/>
