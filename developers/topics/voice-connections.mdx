...
<ManualAnchor id="voice-gateway-versioning-gateway-versions" />
###### Gateway Versions
...
<ManualAnchor id="retrieving-voice-server-information-gateway-voice-state-update-example" />
...
If our request succeeded, the gateway will respond with _two_ events—a [Voice State Update](/developers/events/gateway-events#voice-state-update) event and a [Voice Server Update](/developers/events/gateway-events#voice-server-update) event—meaning your library must properly wait for both events before continuing. The first will contain a new key, `session_id`, and the second will provide voice server information we can use to establish a new voice connection:

<ManualAnchor id="retrieving-voice-server-information-example-voice-server-update-payload" />
...
<ManualAnchor id="establishing-a-voice-websocket-connection-example-voice-ready-payload" />
...
<ManualAnchor id="heartbeating-example-hello-payload" />
...
<ManualAnchor id="heartbeating-example-heartbeat-payload-since-v8" />
...
<ManualAnchor id="heartbeating-example-heartbeat-payload-below-v8" />
...
<ManualAnchor id="heartbeating-example-heartbeat-ack-payload-since-v8" />
...
<ManualAnchor id="heartbeating-example-heartbeat-ack-payload-below-v8" />
...
<ManualAnchor id="establishing-a-voice-udp-connection-example-ready-payload" />
...
<ManualAnchor id="establishing-a-voice-udp-connection-example-select-protocol-payload" />
...
<ManualAnchor id="transport-encryption-modes-example-session-description-payload" />
...
<ManualAnchor id="transport-encryption-modes-voice-packet-structure" />
...
<ManualAnchor id="speaking-example-speaking-payload" />
...
<ManualAnchor id="resuming-voice-connection-example-resume-connection-payload-since-v8" />
...
<ManualAnchor id="resuming-voice-connection-example-resume-connection-payload-before-v8" />
...
<ManualAnchor id="resuming-voice-connection-example-resumed-payload" />
...
<ManualAnchor id="buffered-resume-example-message-with-sequence-number" />
