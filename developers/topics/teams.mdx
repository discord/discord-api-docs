---
title: Managing Your Developer Team
sidebarTitle: Managing Developer Team
...
| field            | type                                                  | description                                                                                       |
|------------------|-------------------------------------------------------|---------------------------------------------------------------------------------------------------|
| membership_state | integer                                               | User's [membership state](/developers/topics/teams#data-models-membership-state-enum) on the team |
| team_id          | snowflake                                             | ID of the parent team of which they are a member                                                  |
| user             | [user](/developers/resources/user#user-object) object | User object of the team member                                                                    |
