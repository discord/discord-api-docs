...
<ManualAnchor id="gateway-gateway-opcodes" />
###### Gateway Opcodes
...
<ManualAnchor id="gateway-gateway-close-event-codes" />
...
<ManualAnchor id="voice-voice-opcodes" />
###### Voice Opcodes
...
<ManualAnchor id="voice-voice-close-event-codes" />
...
<ManualAnchor id="http-http-response-codes" />
###### HTTP Response Codes
...
<ManualAnchor id="json-json-error-codes" />
###### JSON Error Codes
...
<ManualAnchor id="json-example-json-error-response" />
...
<ManualAnchor id="rpc-rpc-error-codes" />
###### RPC Error Codes
...
<ManualAnchor id="rpc-rpc-close-event-codes" />
