...
description: Automate role assignment and targeted invites using the Discord Community Invites API.
---
...
<YouTubeEmbed
  src="https://www.youtube.com/embed/NVQTVlTa9MQ"
  title="Discord Community Invites: New API Changes & Automated Roles Tutorial"
  showDuration
  chapters={`0:00 Introduction to Community Invites
0:26 Automating Role Assignment
0:44 Restricting Access with Target User Files
1:00 Use Cases for Creators
1:46 Solving Developer Friction
3:14 UI Walkthrough
4:04 Attribution Tracking
6:50 Transition to Code Walkthrough
7:42 Identifying IDs
8:26 API Endpoint Deep Dive
9:17 Technical Specs
11:05 Payload JSON and Multi-part Form Data
14:30 Live Code Demonstration
18:15 Handling Existing Members
21:40 Advanced Use Cases
25:20 Conclusion and Survey`}
/>
