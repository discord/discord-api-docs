...
<Info>
If you're a server admin or community manager looking to create role invites without code, see the [Community Invites guide](/developers/communities/community-invites) for the Discord UI walkthrough.
</Info>
