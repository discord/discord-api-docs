...
| file_types?\*\* | array of strings | File types to filter for; can be `image`, `video`, `audio` or any dot-prefixed extension such as `.pdf`; max 10 |
...
| proxy_url? \*           | string    | The proxied url of the media item                                                                                                                                             |
...
| content_type? \*        | string    | The [media type](https://en.wikipedia.org/wiki/Media_type) of the content                                                                                                     |
...
| attachment_id? \* \*\*  | snowflake | The id of the uploaded attachment                                                                                                                                             |
