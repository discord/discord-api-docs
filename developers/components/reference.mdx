...
| components | array of [action row child components](/developers/components/reference#component-object-component-types) | Up to 5 interactive [button](/developers/components/reference#button) components or a single [select](/developers/components/reference#user-select) component |
...
| id?       | integer                                                                                                   | Optional identifier for component                                        |
| custom_id | string                                                                                                    | Developer-defined identifier for the input; 1-100 characters             |
| options   | array of [radio group options](/developers/components/reference#radio-group-radio-group-option-structure) | List of options to show; min 2, max 10                                   |
...
| id?         | integer                                                                                                            | Optional identifier for component                                                                                  |
| custom_id   | string                                                                                                             | Developer-defined identifier for the input; 1-100 characters                                                       |
| options     | array of [checkbox group options](/developers/components/reference#checkbox-group-checkbox-group-option-structure) | List of options to show; min 1, max 10                                                                             |
