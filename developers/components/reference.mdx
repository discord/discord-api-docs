...
The character count of all text display components in a message may total up to
4000 characters, this also means that a single text display may contain 4000
characters compared to the 2000 characters normal messages allow.
