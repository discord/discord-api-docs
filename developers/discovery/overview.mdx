...
Once you've [enabled discovery for your app](/developers/discovery/enabling-discovery), users can find your app in Discord through the App Directory and the App Launcher.
