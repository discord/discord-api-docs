...
<Update label="August 6, 2026" tags={["HTTP API", "Gateway"]} rss={{
    ...
    Guilds that have [Membership Screening](/developers/resources/guild#membership-screening-object) set up with manual approval require prospective members to submit a join request, called a *membership application* in the Discord client. 
