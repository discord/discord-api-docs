...
<Update label="March 19, 2026" tags={["HTTP API"]} rss={{
  ...
  This endpoint requires the `READ_MESSAGE_HISTORY` permission and is subject to restrictions based on whether the `MESSAGE_CONTENT` [Privileged Intent](/developers/events/gateway#privileged-intents) is enabled for your application.
