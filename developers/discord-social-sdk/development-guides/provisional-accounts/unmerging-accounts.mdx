...
* **✅ Blocks**: Users the original Discord account blocked are copied to the new provisional account
...
Blocks are copied rather than moved. The original Discord account keeps every block it had, and the new provisional account receives its own copy of them.
...
| Date              | Changes                                                   |
|-------------------|-----------------------------------------------------------|
| September 8, 2026 | Document block migration during unmerges                  |
