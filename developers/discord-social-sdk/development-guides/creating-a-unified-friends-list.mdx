...
<CardGroup cols={3}>
  <Card title="Designing a Unified Friends List" href="/developers/discord-social-sdk/design-guidelines/unified-friends-list" icon={<PaintPaletteIcon />}>
    Best practices for designing your Unified Friends List.
  </Card>
  <Card title="Managing Relationships" href="/developers/discord-social-sdk/development-guides/managing-relationships" icon={<UserIcon />}>
