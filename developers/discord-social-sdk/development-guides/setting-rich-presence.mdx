...
<Tip>
Registered application names are restricted to a limited character set — for example, you can't use a colon (`:`). Using [`Activity::SetName`] gives you more flexibility over exactly what text is displayed, including characters that aren't permitted in your registered application name.
</Tip>
