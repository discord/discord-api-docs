...
import CommunicationScopeCallout from '/snippets/discord-social-sdk/callouts/oauth-comms-scopes.mdx';
...
<YouTubeEmbed
        src="https://www.youtube.com/embed/ENvpjjDAP8I"
        title="Unity Game Dev: Build Lobbies, Invites, & Rich Presence with Discord Social SDK"
        showDuration
/>
...
<CardGroup cols={3}>
  ...
  <Card title="Sending Direct Messages" href="/developers/discord-social-sdk/development-guides/sending-direct-messages" icon={<InboxIcon />}>
