...
description: Integrate Discord voice chat features into your application.
---
...
<Info>
[`VoiceSettings`] is a read-only snapshot of the client's configuration at the time it was fetched or pushed to you. Reading it does not let you change the user's actual Discord client settings — use the [Controlling Voice Features](#controlling-voice-features) controls above to affect the current call.
</Info>
...
[`Client::SetVoiceSettingsUpdatedCallback`]: https://discord.com/developers/docs/social-sdk/classdiscordpp_1_1Client.html#a2006d6b52b1665fb51172a98c3a37661
...
[`VoiceSettings`]: https://discord.com/developers/docs/social-sdk/classdiscordpp_1_1VoiceSettings.html#a86c7a88db489367af48ef420a7f56eaa
