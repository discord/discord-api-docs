...
- If there is an existing _full Discord account_ associated with the identity, the request is aborted (See [Error Handling](/developers/discord-social-sdk/development-guides/using-provisional-accounts#error-handling)).
...
<CardGroup cols={3}>
 <Card title="Design: Provisional Accounts" href="/developers/discord-social-sdk/design-guidelines/provisional-accounts" icon={<PaintPaletteIcon />}>
