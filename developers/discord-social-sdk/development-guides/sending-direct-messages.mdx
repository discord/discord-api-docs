...
<Info>
This disclosure message does not appear in the channel or lobby's message history—it's generated only in the sending user's own client and is not persisted or synced anywhere else. It is private to that user; other members of the channel or lobby will not see it.
</Info>
...
| Date              | Changes                                                          |
|-------------------|------------------------------------------------------------------|
| September 9, 2026 | Correct legal disclosure message privacy scope                   |
| September 8, 2026 | Clarify legal disclosure message visibility and history behavior |
