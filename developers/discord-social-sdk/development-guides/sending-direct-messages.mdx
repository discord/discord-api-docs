...
<Info>
This disclosure message is injected client-side only and does not appear in the channel or lobby's message history. It is also not tied to a specific user—everyone in the channel or lobby will see it, rather than it being a private disclosure shown only to one person.
</Info>
