...
<Info>
If `Open Visual Studio` is greyed out, use `New C++ Class...` to create a throwaway class, which will also autogenerate other folders and files you'll need. You can delete the throwaway class after code generation completes.
</Info>
