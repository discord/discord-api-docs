...
If you are new to the Discord Social SDK, we recommend you start with the [Getting Started](/developers/discord-social-sdk/getting-started) guide.
...
<CardGroup cols={3}>
  ...
  <Card title="Account Linking on Consoles" href="/developers/discord-social-sdk/development-guides/account-linking-on-consoles" icon={<GameControllerIcon/>}>
  Implement Discord authentication flows for console platforms.
  </Card>
  <Card title="Account Linking on Mobile" href="/developers/discord-social-sdk/development-guides/account-linking-on-mobile" icon={<MobilePhoneIcon/>}>
    Implement OAuth2 authentication for iOS and Android with deep linking and PKCE.
  </Card>
  <Card title="Account Linking from Discord" href="/developers/discord-social-sdk/development-guides/account-linking-from-discord" icon={<ClydeIcon/>}>
    Allow players to link their game accounts from the Discord client.
  </Card>
  <Card title="Using Provisional Accounts" href="/developers/discord-social-sdk/development-guides/provisional-accounts/overview" icon={<MagicWandIcon/>}>
    Give your users a seamless account experience with provisional accounts.
  </Card>
  <Card title="Publisher Level Account Linking" href="/developers/discord-social-sdk/development-guides/publisher-level-account-linking" icon={<ShopIcon/>}>
