...
description: How-to guides for integrating Discord Social SDK features into your game.
---
...
<CardGroup cols={3}>
    ...
    <Card title="Integrate Moderation" href="/developers/discord-social-sdk/how-to/integrate-moderation" icon={<ShieldIcon/>}>
        Integrating and managing content moderation for your game when using the Discord Social SDK.
    </Card>
    <Card title="Market Your Integration" href="/developers/discord-social-sdk/how-to/market-your-integration" icon={<StarShootingIcon/>}>
    ...
    <Card title="Handle Rate Limits"
          href="/developers/discord-social-sdk/how-to/handle-rate-limits"
          icon={<WrenchIcon/>}>
