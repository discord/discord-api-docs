...
Check out the [Provisional Accounts overview](/developers/discord-social-sdk/development-guides/provisional-accounts/overview) for a detailed explanation of how provisional accounts work, why they matter, and how to implement them in your game.

| Development Guides                                                                                                                    |
|---------------------------------------------------------------------------------------------------------------------------------------|
| [Provisional Accounts Overview](/developers/discord-social-sdk/development-guides/provisional-accounts/overview)                      |
| [Bot Token Endpoint](/developers/discord-social-sdk/development-guides/provisional-accounts/bot-token-endpoint)                       |
| [Configuring Identity Providers](/developers/discord-social-sdk/development-guides/provisional-accounts/identity-providers)           |
| [External Credentials Exchange](/developers/discord-social-sdk/development-guides/provisional-accounts/external-credentials-exchange) |
| [Public Client Integration](/developers/discord-social-sdk/development-guides/provisional-accounts/public-client)                     |
| [Managing Provisional Accounts](/developers/discord-social-sdk/development-guides/provisional-accounts/managing-accounts)             |
| [Merging Accounts](/developers/discord-social-sdk/development-guides/provisional-accounts/merging-accounts)                           |
| [Unmerging Accounts](/developers/discord-social-sdk/development-guides/provisional-accounts/unmerging-accounts)                       |
