...
The supported version window is currently:
...
This model applies from the 1.10 release (July 2026) onward. Releases 1.6–1.9 keep the console OS SDK support they originally shipped with.
