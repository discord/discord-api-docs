...
|---------------------------------------------------------------------------------------------------------|----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| [Provisional Accounts](/developers/discord-social-sdk/development-guides/provisional-accounts/overview) | No special considerations                                                                                                                                                                                                                                                                                                                                                        |
| [Account Linking](/developers/discord-social-sdk/development-guides/account-linking-with-discord)       | Requires deep linking (`discord-APP_ID:/authorize/callback`). Discord mobile app launches first for authentication, reusing an existing signed-in session if present, falls back to browser if not installed. See [Account Linking on Mobile](/developers/discord-social-sdk/development-guides/account-linking-on-mobile)                                                       |
| [Friends & Relationships](/developers/discord-social-sdk/development-guides/managing-relationships)     | No special considerations                                                                                                                                                                                                                                                                                                                                                        |
| [Rich Presence](/developers/discord-social-sdk/development-guides/setting-rich-presence)                | On iOS, requires account linking — you cannot publish presence without linking first. On Android, presence can also be published without account linking, as on desktop, if the Discord app is installed and signed in. See [Rich Presence Without Authentication](/developers/discord-social-sdk/development-guides/setting-rich-presence#rich-presence-without-authentication) |
...
| Date              | Changes                                                                            |
|-------------------|------------------------------------------------------------------------------------|
| September 8, 2026 | Noted that mobile account linking reuses an existing signed-in Discord app session |
