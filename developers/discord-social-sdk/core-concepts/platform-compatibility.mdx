...
<Tip>
Building for iOS or Android? See [Feature Availability on Mobile](/developers/discord-social-sdk/core-concepts/mobile-development#feature-availability-on-mobile) for which features are supported on each mobile platform and under what conditions.
</Tip>
