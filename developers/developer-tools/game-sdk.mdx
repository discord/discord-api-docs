...
title: Game SDK
tag: "LEGACY"
description: Legacy Game SDK documentation for integrating games with Discord.
---

<Warning>
**The Game SDK has been archived.**

We recommend using the [Discord Social SDK](/developers/discord-social-sdk/overview) for new projects.

Existing projects using the Game SDK will continue to work, but we encourage you to migrate to the [Discord Social SDK](/developers/discord-social-sdk/overview) for new features and updates.
</Warning>
...
This section will walk you through the first few steps you need to take to get up-and-running with the Game SDK. After you download the SDK and configure your app, you can find more details in the [Using the SDK section](/developers/developer-tools/game-sdk#using-the-sdk).
...
Next, we need to set up the application for your game. An [app](/developers/resources/application) is the base "entity" in Discord for your game.
...
<Accordion title="Code Primer for Unity (C#)" icon="code">
...
<Accordion title="Code Primer for Non-Unity Projects (C#)" icon="code">
- Open up that SDK zip that you downloaded.
...
<Accordion title="Code Primer for Unreal Engine (C)" icon="code">
...
<Accordion title="Code Primer for Unreal Engine 4 (C++)" icon="code">
...
<Accordion title="Code Primer for No Engine (C++)" icon="code">
...
| Name                                                                 | Description                                                |
|----------------------------------------------------------------------|------------------------------------------------------------|
| [`ActivityManager`](/developers/developer-tools/game-sdk#activities) | for Rich Presence and game invites                         |
| [`OverlayManager`](/developers/developer-tools/game-sdk#overlay)     | for interacting with Discord's built-in overlay            |
| [`UserManager`](/developers/developer-tools/game-sdk#users)          | for fetching user data for a given id and the current user |
...
<Accordion title="Example calling a function with our C# binding" icon="code">
...
<Accordion title="Using SetLogHook for Error Handling in the SDK" icon="code">
...
<Accordion title="How do I test locally while developing?" icon="question">
...
<Accordion title="Codes and Values for the Result Enum" icon="eye">
...
<Accordion title="Values for the LogLevel Enum" icon="eye">
...
<Accordion title="Values for the CreateFlags Enum" icon="eye">
...
<Info>
Looking to build a game inside of Discord? Check out the (other) [Activities](/developers/activities/overview) and the [Embedded SDK](/developers/developer-tools/embedded-app-sdk) documentation.
</Info>
...
For more detailed information and documentation around the Rich Presence feature set and integration tips, check out our [Rich Presence Documentation](/developers/rich-presence/overview).
...
| timestamps?   | ?[ActivityTimestamps](/developers/developer-tools/game-sdk#activitytimestamps-struct) | helps create elapsed/remaining timestamps on a player's profile |
| assets?       | ?[ActivityAssets](/developers/developer-tools/game-sdk#activityassets-struct)         | assets to display on the player's profile                       |
| party?        | ?[ActivityParty](/developers/developer-tools/game-sdk#activityparty-struct)           | information about the player's party                            |
| secrets?      | ?[ActivitySecrets](/developers/developer-tools/game-sdk#activitysecrets-struct)       | secret passwords for joining and spectating the player's game   |
...
| name        | type    | description                                                                                        |
|-------------|---------|----------------------------------------------------------------------------------------------------|
| largeImage? | ?string | see [Activity Asset Image](/developers/events/gateway-events#activity-object-activity-asset-image) |
| largeText?  | ?string | hover text for the large image                                                                     |
| smallImage? | ?string | see [Activity Asset Image](/developers/events/gateway-events#activity-object-activity-asset-image) |
...
For more details about the activity types, [see Gateway documentation](/developers/events/gateway-events#activity-object-activity-types).
...
<Accordion title="Activity Action Field Requirements" icon="eye">
...
<Accordion title="UpdateActivity Example" icon="code">
...
<Accordion title="ClearActivity Example" icon="code">
...
<Accordion title="SendRequestReply Example" icon="code">
...
Sends a game invite to a given user. If you do not have a valid activity with all the required fields, this call will error. See [Activity Action Field Requirements](/developers/developer-tools/game-sdk#activity-action-field-requirements) for the fields required to have join and spectate invites function properly.
...
<Accordion title="SendInvite Example" icon="code">
...
<Accordion title="AcceptInvite Example" icon="code">
...
<Accordion title="OnActivityJoin Example" icon="code">
...
<Accordion title="OnActivitySpectate Example" icon="code">
...
<Accordion title="OnActivityJoinRequest Example" icon="code">
...
<Accordion title="OnActivityInvite Example" icon="code">
...
<Accordion title="Code example for inviting a user to a game" icon="code">
...
<Accordion title="IsEnabled Example" icon="code">
...
<Accordion title="IsLocked Example" icon="code">
...
<Accordion title="SetLocked Example" icon="code">
...
<Accordion title="OpenActivityInvite Example" icon="code">
...
Returns a `Discord.Result` via callback. Note that a successful `Discord.Result` response does not necessarily mean that the user has joined the guild. If you want more granular control over and knowledge about users joining your guild, you may want to look into implementing the [`guilds.join` OAuth2 scope in an authorization code grant](/developers/topics/oauth2#authorization-code-grant) in conjunction with the [Add Guild Members](/developers/resources/guild#add-guild-member) endpoint.
...
<Accordion title="OpenGuildInvite Example" icon="code">
...
<Accordion title="Screenshot of the Voice Settings modal for an application" icon="eye">
...
<Accordion title="OpenVoiceSettings Example" icon="code">
...
<Accordion title="OnToggle Example" icon="code">
...
<Accordion title="Example activiting overlay invite modal" icon="code">
...
<Accordion title="GetUser Example" icon="code">
...
Get the [PremiumType](/developers/developer-tools/game-sdk#premiumtype-enum) for the currently connected user.

Returns `Discord.PremiumType`.

###### Example

<Accordion title="GetCurrentUserPremiumType Example" icon="code">
...
See whether or not the current user has a certain [UserFlag](/developers/developer-tools/game-sdk#userflag-enum) on their account.
...
| name | type                                                           | description                             |
|------|----------------------------------------------------------------|-----------------------------------------|
| flag | [UserFlag](/developers/developer-tools/game-sdk#userflag-enum) | the flag to check on the user's account |

###### Example

<Accordion title="CurrentUserHasFlag Example" icon="code">
...
<Accordion title="OnCurrentUserUpdate Example" icon="code">
...
<Accordion title="Example using the Users manager to fetch data about a Discord user" icon="code">
