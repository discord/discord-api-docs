...
<div id="homepage-hero">
    <div id="hero-text">
        ...
        <div id="hero-image">
          <img src="/images/frame-wumpus.png" alt="Discord Developers" noZoom />
        </div>
  </div>
</div>
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    href="/developers/discord-social-sdk/overview"
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon={<SlashBoxIcon />}
    href="/developers/interactions/overview#message-components"
    horizontal
  >
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon={<WrenchIcon />}
    href="/developers/activities/building-an-activity"
    horizontal
  >
  ...
  <Card
    ...
    href="/developers/activities/design-patterns"
    horizontal
  >
...
<CardGroup cols={3}>
  ...
  <Card
    ...
    icon={<WrenchIcon />}
    href="/developers/discord-social-sdk/getting-started"
    horizontal
  >
  ...
  <Card
    ...
    icon={<PaintPaletteIcon />}
    href="/developers/discord-social-sdk/design-guidelines"
    horizontal
  >
