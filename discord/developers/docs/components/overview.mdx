...
<Info>
[Legacy message component behavior](/developers/docs/components/reference#legacy-message-component-behavior) will **not** be deprecated and will continue to be available to your apps on a message-by-message basis. However, we recommend using the new components for new projects and features.
</Info>
...
<CardGroup cols={3}>
  <Card title="Using Message Components" href="/developers/docs/components/using-message-components" icon={<ChatDotsIcon />}>
    A guide on sending Message Components with examples.
  </Card>
   <Card title="Using Modal Components" href="/developers/docs/components/using-modal-components" icon={<CompassIcon />}>
    A guide on sending Modal Components with examples.
  </Card>
  <Card title="Component Reference" href="/developers/docs/components/reference" icon={<BrowserIcon />}>
