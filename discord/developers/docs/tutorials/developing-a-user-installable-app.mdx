...
![Installation settings in App Settings](/images/tutorials/user-install-settings.png)
...
<Accordion title="Contexts for application commands" description="A brief introduction to command contexts" icon="view" defaultOpen>
...
<Accordion title="Sample interaction payload" icon="code" defaultOpen>
...
<Accordion title="Using context for the profile command" icon="code" >
...
![Sample game command response](/images/tutorials/user-install-game-message.png)
...
<CardGroup>
  <Card title="Interactions documentation" href="/developers/docs/interactions/overview">
    Explore the Interactions documentation to learn more about receiving and responding to commands and message components
  </Card>
  <Card title="Github repository" href="https://github.com/discord/user-install-example">
