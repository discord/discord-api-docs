...
![IDs found in app settings](/images/tutorials/cloudflare-general-overview.png)
...
![Configuring bot permissions in app settings](/images/tutorials/cloudflare-url-generator.png)
...
![ngrok forwarding address](/images/tutorials/cloudflare-ngrok.png)
...
![Interactions Endpoint URL](/images/tutorials/cloudflare-interactions-endpoint.png)
