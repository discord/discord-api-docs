...
- See the below [Quality & Testing Recommendations](/developers/docs/activities/design-patterns#quality-and-testing) for key areas of minimum quality support and testing recommendations.
- See the below [Technical Considerations](/developers/docs/activities/design-patterns#technical-considerations) for recommendations on how to partition loading and work with various development tools to reduce load times.
...
<ManualAnchor id="if-a-game-is-launched-what-%-of-the-time-do-users-reach-different-phases-of-the-game" />
