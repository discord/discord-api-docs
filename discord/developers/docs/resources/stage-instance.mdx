...
## Get Stage Instance
<Route method="GET">/stage-instances/[\{channel.id\}](/developers/docs/resources/channel#channel-object)</Route>

Gets the stage instance associated with the Stage channel, if it exists.

## Modify Stage Instance
<Route method="PATCH">/stage-instances/[\{channel.id\}](/developers/docs/resources/channel#channel-object)</Route>
...
<Route method="DELETE">/stage-instances/[\{channel.id\}](/developers/docs/resources/channel#channel-object)</Route>
