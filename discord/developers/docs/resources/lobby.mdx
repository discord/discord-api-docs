...
## Get Lobby
<Route method="GET">/lobbies/[\{lobby.id\}](/developers/docs/resources/lobby#lobby-object)</Route>

Returns a [lobby](/developers/docs/resources/lobby#lobby-object) object for the specified lobby id, if it exists.

## Modify Lobby
<Route method="PATCH">/lobbies/[\{lobby.id\}](/developers/docs/resources/lobby#lobby-object)</Route>
...
## Delete Lobby
<Route method="DELETE">/lobbies/[\{lobby.id\}](/developers/docs/resources/lobby#lobby-object)</Route>
...
<Route method="PUT">/lobbies/[\{lobby.id\}](/developers/docs/resources/lobby#lobby-object)/members/[\{user.id\}](/developers/docs/resources/user#user-object)</Route>
...
<Route method="DELETE">/lobbies/[\{lobby.id\}](/developers/docs/resources/lobby#lobby-object)/members/[\{user.id\}](/developers/docs/resources/user#user-object)</Route>
...
## Leave Lobby
<Route method="DELETE">/lobbies/[\{lobby.id\}](/developers/docs/resources/lobby#lobby-object)/members/@me</Route>
...
<Route method="PATCH">/lobbies/[\{lobby.id\}](/developers/docs/resources/lobby#lobby-object)/channel-linking</Route>
