...
## Get User
<Route method="GET">/users/[\{user.id\}](/developers/docs/resources/user#user-object)</Route>
...
<Route method="GET">/users/@me/guilds/[\{guild.id\}](/developers/docs/resources/guild#guild-object)/member</Route>
...
## Leave Guild
<Route method="DELETE">/users/@me/guilds/[\{guild.id\}](/developers/docs/resources/guild#guild-object)</Route>
...
<Route method="GET">/users/@me/applications/[\{application.id\}](/developers/docs/resources/application#application-object)/role-connection</Route>
...
<Route method="PUT">/users/@me/applications/[\{application.id\}](/developers/docs/resources/application#application-object)/role-connection</Route>
