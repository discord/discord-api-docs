...
<Route method="GET">/skus/[\{sku.id\}](/developers/docs/resources/sku#sku-object)/subscriptions</Route>
...
<Route method="GET">/skus/[\{sku.id\}](/developers/docs/resources/sku#sku-object)/subscriptions/[\{subscription.id\}](/developers/docs/resources/subscription#subscription-object)</Route>
