...
<ManualAnchor id="sku-object-sku-structure" />
###### SKU Structure
...
<ManualAnchor id="sku-object-sku-example" />
###### SKU Example
...
<ManualAnchor id="sku-object-sku-types" />
###### SKU Types
...
<ManualAnchor id="sku-object-sku-flags" />
###### SKU Flags
...
## List SKUs
<Route method="GET">/applications/[\{application.id\}](/developers/docs/resources/application#application-object)/skus</Route>
