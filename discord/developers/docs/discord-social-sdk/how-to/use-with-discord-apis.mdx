---
title: Use with Discord APIs
description: Combine Discord Social SDK with Discord's REST APIs for enhanced functionality.
---
...
<CardGroup cols={3}>
  ...
  <Card title="Design Guidelines for Rich Presence" href="/developers/docs/discord-social-sdk/design-guidelines/status-rich-presence" icon={<UserStatusIcon />}>
