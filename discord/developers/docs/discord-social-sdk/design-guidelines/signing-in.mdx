---
title: Signing In
description: Design guidelines for implementing Discord sign-in flows and authentication.
---
...
Sign-in or log-in flows all begin with the interaction of a [**Discord-styled button**](/developers/docs/discord-social-sdk/design-guidelines/branding-guidelines#buttons).
...
- [Development Guide: Account Linking with Discord](/developers/docs/discord-social-sdk/development-guides/account-linking-with-discord)
