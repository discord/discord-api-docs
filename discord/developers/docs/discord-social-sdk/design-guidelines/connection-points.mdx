...
description: Design guidelines for creating effective connection points between your application and Discord.
---

[Home](/developers/docs/intro) > [Discord Social SDK](/developers/docs/discord-social-sdk/overview) > [Design Guidelines](/developers/docs/discord-social-sdk/design-guidelines) > Connection Points
...
Please use the [**Blurple Button**](/developers/docs/discord-social-sdk/design-guidelines/branding-guidelines#buttons) button styling for the sign-in connection point.
...
![Friends List](/images/social-sdk/design-guidelines/ConnectionPoints-04.png)
...
![Content Guidelines](/images/social-sdk/design-guidelines/ConnectionPoints-05.png)
