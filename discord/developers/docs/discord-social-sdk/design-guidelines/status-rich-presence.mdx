---
title: Status & Rich Presence
description: Design guidelines for displaying user status and Rich Presence information.
---
...
Please refer to [**Setting Rich Presence**](/developers/docs/discord-social-sdk/development-guides/setting-rich-presence) for more information on Rich Presence, such as other types of traits that can be included.
...
- [Development Guide: Setting Rich Presence](/developers/docs/discord-social-sdk/development-guides/setting-rich-presence)
