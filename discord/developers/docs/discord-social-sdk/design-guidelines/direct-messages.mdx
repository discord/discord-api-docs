...
description: Design guidelines for implementing Discord direct messaging features in your application.
---

## Badge when online elsewhere

The badging logic in direct-messages is consistent with the logic detailed in the [Unified Friends List](/developers/docs/discord-social-sdk/design-guidelines/unified-friends-list) section.
...
- [Development Guide: Direct Messages](/developers/docs/discord-social-sdk/development-guides/sending-direct-messages)
