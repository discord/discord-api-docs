...
description: Get started with the Discord Social SDK in C++ applications.
---
import AppCreationSteps from '/snippets/discord-social-sdk/partials/getting-started.mdx'
...
import DylibMacError from '/snippets/discord-social-sdk/partials/dylib-mac-error.mdx';
...
<Accordion title="main.cpp with event handling" icon="code">
...
<Accordion title="main.cpp with Account Linking" icon="code">
```cpp
#define DISCORDPP_IMPLEMENTATION
#include "discordpp.h"
#include <iostream>
...
<Accordion title="main.cpp with SDK connection" icon="code">
```cpp
#define DISCORDPP_IMPLEMENTATION
#include "discordpp.h"
#include <iostream>
...
<Accordion title="main.cpp with friends count" icon="code">
```cpp
#define DISCORDPP_IMPLEMENTATION
#include "discordpp.h"
#include <iostream>
...
<Accordion title="main.cpp complete" icon="code">
```cpp
#define DISCORDPP_IMPLEMENTATION
#include "discordpp.h"
#include <iostream>
