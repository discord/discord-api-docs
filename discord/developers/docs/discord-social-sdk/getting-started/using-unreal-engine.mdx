...
<Accordion title="The full DiscordSocialUnreal.Build.cs" icon="code">
```cs
...
<Accordion title="The full DiscordSocialUnrealCharacter.cpp" icon="code">
```cpp
// Copyright Epic Games, Inc. All Rights Reserved.
...
<Accordion title="The full DiscordSocialUnrealCharacter.h" icon="code">
```cpp
// Copyright Epic Games, Inc. All Rights Reserved.
