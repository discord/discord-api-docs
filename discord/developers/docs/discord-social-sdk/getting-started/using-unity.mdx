...
<Info>
The Unity plugin handles running the SDK callbacks for you in Unity, no need to use [`RunCallbacks`] like we do in the [C++ guide](/developers/docs/discord-social-sdk/getting-started/using-c++).
</Info>
...
<Accordion title="DiscordManager.cs up to this point" icon="code">
```cs
using UnityEngine;
using UnityEngine.UI;
using Discord.Sdk;
...
<Accordion title="The full DiscordManager.cs" icon="code">
```cs
using UnityEngine;
using UnityEngine.UI;
using Discord.Sdk;
