---
title: Managing Relationships in Your Game
sidebarTitle: Managing Relationships
description: Manage Discord user relationships including friends and blocked users in your application.
---
...
- Completed the [Getting Started](/developers/docs/discord-social-sdk/getting-started) guide
- Completed the [Creating a Unified Friends List](/developers/docs/discord-social-sdk/development-guides/creating-a-unified-friends-list) guide
...
Once you've [created a unified friends list](/developers/docs/discord-social-sdk/development-guides/creating-a-unified-friends-list), you can start managing relationships between players in your game. 
...
<CardGroup cols={3}>
  ...
  <Card title="Managing Lobbies" href="/developers/docs/discord-social-sdk/development-guides/managing-lobbies" icon={<UserIcon />}>
