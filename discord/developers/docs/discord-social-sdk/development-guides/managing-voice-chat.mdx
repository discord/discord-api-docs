...
the complete [Managing Lobbies Guide](/developers/docs/discord-social-sdk/development-guides/managing-lobbies).
</Info>
...
<CardGroup cols={3}>
    <Card title="Integrate Moderation" href="/developers/docs/discord-social-sdk/how-to/integrate-moderation"
          icon={<MagicWandIcon />}>
    ...
    <Card title="Managing Game Invites" href="/developers/docs/discord-social-sdk/development-guides/managing-game-invites"
          icon={<InboxIcon />}>
