...
The Discord Social SDK introduces additional message objects for lobby and direct message events.
...
Standard Discord [Message Object](/docs/resources/message#messages-resource) with additional fields.
