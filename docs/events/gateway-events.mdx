...
| metadata        | [metadata activity object]()                                                         | The metadata of this activity, only available if it is a custom activity type                                                    |
...
| Field | Type    | Description                                                                             |
|-------|---------|-----------------------------------------------------------------------------------------|
| label | string? | The activity status label; either `question`, `think`, `love`, `recommend` or `excited` |
