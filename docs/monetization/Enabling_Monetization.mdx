...
Before you can add monetization to your app, you need to ensure that your app and team meet the eligibility criteria. 
...
Once these are complete, you can [create SKUs](#DOCS_MONETIZATION_MANAGING_YOUR_STORE/creating-skus) to represent your premium offerings and [add support for your premium offering](#DOCS_MONETIZATION_ENABLING_MONETIZATION/handling-monetization-in-your-app) in your app.
...
Before you can start creating SKUs and offering payments in your app, your app and team must be eligible for monetization.

 When a team owner enables monetization, they'll be taken through a series of steps and checks to ensure the following criteria are met:
...
Let's setup Team Payouts so you can get paid! Discord does all payout processing through Stripe, so part of setting up payouts will be going through Stripe's onboarding flow.
...
You are now ready to start setting up your SKUs and offering premium features in your app. Check out our guide on [Managing your Premium Offerings](#DOCS_MONETIZATION_MANAGING_YOUR_STORE/creating-skus) to create one-time purchases and subscriptions for your app.
...
> danger
> TODO: Swap these out for cards?

- [Implementing App Subscriptions](#DOCS_MONETIZATION_IMPLEMENTING_APP_SUBSCRIPTIONS): Learn how to start and manage recurring subscriptions within your app.
- [Implementing One-Time Purchases](#DOCS_MONETIZATION_IMPLEMENTING_ONE-TIME_PURCHASES): Learn how to handle one-time purchases for individual features, content, or items.
- Implementing IAP (In-App Purchases) in Activities: Learn how to implement subscriptions and one-time purchases in an Activity. (✨ coming soon ✨)
