...
![Supporting multiple subscription tiers](multisub.webp)
...
![Example of SKU benefits](sku-benefits.webp)
...
![Set a unicode emoji](sku-unicode.webp)
</Collapsible>
...
![Set a custom emoji](sku-custom.webp)
</Collapsible>
...
![Accessing the store as a user](botuser-profile.webp)

#### Subscriptions in Your Store page
![Subscriptions in your Store View](multisub.webp)

#### Items in Your Store page
![Items in your Store View](premium-items.webp)
...
![Embed for direct link to SKU](sku_embed.webp)
...
![Embed for direct link to Store](store_embed.webp)
