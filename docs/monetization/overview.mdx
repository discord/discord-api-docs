...
![Monetizing Your Discord App](monetization-overview.webp)
...
- [Subscriptions](#DOCS_RESOURCES_SUBSCRIPTION) represent an ongoing agreement where a user commits to paying for an entitlement on a recurring basis until canceled.
