...
| type           | integer   | [Type of SKU](/docs/monetization/SKUs#sku-types)                                                                 |
...
| flags          | integer   | [SKU flags](/docs/monetization/SKUs#sku-flags) combined as a [bitfield](https://en.wikipedia.org/wiki/Bit_field) |
...
<RoutePill method="GET">/applications/[\{application.id\}](/docs/resources/Application#application-object)/skus</RoutePill>
