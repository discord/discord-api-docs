...
| type           | integer   | [Type of SKU](/monetization/skus#sku-types)                                                                 |
...
| flags          | integer   | [SKU flags](/monetization/skus#sku-flags) combined as a [bitfield](https://en.wikipedia.org/wiki/Bit_field) |
...
<RoutePill method="GET">/applications/[\{application.id\}](/resources/application#application-object)/skus</RoutePill>
