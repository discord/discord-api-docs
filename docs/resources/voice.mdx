...
Returns an array of [voice region](/resources/voice#voice-region-object) objects that can be used when setting a voice or stage channel's [`rtc_region`](/resources/channel#channel-structure).
