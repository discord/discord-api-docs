...
| VOICE_CHANNEL_STATUS_UPDATE                 | 192   | A voice channel status was udpated by a user              | [Channel](#DOCS_RESOURCES_CHANNEL/channel-object)                                                                                                |
| VOICE_CHANNEL_STATUS_DELETE                 | 193   | A voice channel status was deleted by a user              | [Channel](#DOCS_RESOURCES_CHANNEL/channel-object)                                                                                                |
...
| status                            | string    | The new voice channel status                                     | VOICE_CHANNEL_STATUS_UPDATE                                                                                                                                                                                                                                                                                    |
