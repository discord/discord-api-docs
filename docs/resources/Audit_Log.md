...
| AUTO_MODERATION_FLAG_TO_CHANNEL             | 144   | Message was flagged by AutoMod (according to a rule)      |                                                                                                                                                  |
| AUTO_MODERATION_USER_COMMUNICATION_DISABLED | 145   | Member was timed out by AutoMod (according to a rule)     |                                                                                                                                                  |
