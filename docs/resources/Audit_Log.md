...
| communication_disabled_until | [user](#DOCS_RESOURCES_USER/user-object) | ?ISO8601 timestamp                              | the user's [timeout](https://support.discord.com/hc/en-us/articles/4413305239191-Time-Out-FAQ) is set |
