...
| allow                         | [role](#DOCS_TOPICS_PERMISSIONS/role-object)            | string                                                                                  | legacy: a permission on a text or voice channel was allowed for a role                                                                                  |
| deny                          | [role](#DOCS_TOPICS_PERMISSIONS/role-object)            | string                                                                                  | legacy: a permission on a text or voice channel was denied for a role                                                                                   |
