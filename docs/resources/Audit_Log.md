...
| permissions                   | [role](#DOCS_RESOURCES_GUILD/role-object)               | integer                                                                                  | legacy [permissions](#DOCS_TOPICS_PERMISSIONS/permissions-bitwise-permission-flags) for a role changed                                                  |
| permissions_new               | [role](#DOCS_RESOURCES_GUILD/role-object)               | string                                                                                   | [permissions](#DOCS_TOPICS_PERMISSIONS/permissions-bitwise-permission-flags) for a role changed                                                         |
...
| allow                         | [role](#DOCS_TOPICS_PERMISSIONS/role-object)            | integer                                                                                  | legacy: a permission on a text or voice channel was allowed for a role                                                                                  |
| allow_new                     | [role](#DOCS_TOPICS_PERMISSIONS/role-object)            | string                                                                                   | a permission on a text or voice channel was allowed for a role                                                                                          |
| deny                          | [role](#DOCS_TOPICS_PERMISSIONS/role-object)            | integer                                                                                  | legacy: a permission on a text or voice channel was denied for a role                                                                                   |
| deny_new                      | [role](#DOCS_TOPICS_PERMISSIONS/role-object)            | string                                                                                   | a permission on a text or voice channel was denied for a role                                                                                           |
