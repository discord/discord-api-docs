...
| roles?                      | array of [role](/docs/topics/permissions#role-object) objects                                      | the roles assigned to the user upon accepting the invite                                                           |
...
Updates the users allowed to see and accept this invite. Uploading a file with invalid user IDs will result in a 400 with the invalid IDs described.
