...
<RoutePill method="GET">/invites/[\{invite.code\}](/docs/resources/Invite#invite-object)</RoutePill>
...
<RoutePill method="DELETE">/invites/[\{invite.code\}](/docs/resources/Invite#invite-object)</RoutePill>
