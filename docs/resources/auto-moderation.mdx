...
Auto Moderation is a feature which allows each [guild](/resources/guild) to set up rules that trigger based on some criteria. For example, a rule can trigger whenever a message contains a specific keyword.
...
| event_type       | integer                                                                             | the rule [event type](/resources/auto-moderation#event-types)            |
| trigger_type     | integer                                                                             | the rule [trigger type](/resources/auto-moderation#trigger-types)        |
| trigger_metadata | object                                                                              | the rule [trigger metadata](/resources/auto-moderation#trigger-metadata) |
| actions          | array of [action](/resources/auto-moderation#auto-moderation-action-object) objects | the actions which will execute when the rule is triggered                |
...
value of [trigger_type](/resources/auto-moderation#trigger-types).
...
| presets                         | array of [keyword preset types](/resources/auto-moderation#keyword-preset-types) | KEYWORD_PRESET           | the internally pre-defined wordsets which will be searched for in content         |
...
\* A keyword can be a phrase which contains multiple words. [Wildcard symbols](/resources/auto-moderation#keyword-matching-strategies) can be used to customize how each keyword will be matched. Each keyword must be 60 characters or less.
...
\*** Each `allow_list` keyword can be a phrase which contains multiple words. [Wildcard symbols](/resources/auto-moderation#keyword-matching-strategies) can be used to customize how each keyword will be matched. Rules with `KEYWORD` [trigger_type](/resources/auto-moderation#trigger-types) accept a maximum of 100 keywords. Rules with `KEYWORD_PRESET` [trigger_type](/resources/auto-moderation#trigger-types) accept a maximum of 1000 keywords.
...
| Field       | Type                                                          | Description                                                               |
|-------------|---------------------------------------------------------------|---------------------------------------------------------------------------|
| type        | [action type](/resources/auto-moderation#action-types)        | the type of action                                                        |
| metadata? * | [action metadata](/resources/auto-moderation#action-metadata) | additional metadata needed during execution for this specific action type |

\* Can be omitted based on `type`. See the `Associated Action Types` column in [action metadata](/resources/auto-moderation#action-metadata) to understand which `type` values require `metadata` to be set.
...
value of [action type](/resources/auto-moderation#action-types).
...
Some [action types](/resources/auto-moderation#action-types) require additional permissions, e.g. the `TIMEOUT` action type requires an additional `MODERATE_MEMBERS` permission.

## List Auto Moderation Rules for Guild

<RoutePill method="GET">/guilds/[\{guild.id\}](/resources/guild#guild-object)/auto-moderation/rules</RoutePill>

Get a list of all rules currently configured for the guild. Returns a list of [auto moderation rule](/resources/auto-moderation#auto-moderation-rule-object) objects for the given guild.

:::info
This endpoint requires the `MANAGE_GUILD` [permission](/resources/auto-moderation#auto-moderation-permission-requirements).
:::

## Get Auto Moderation Rule

<RoutePill method="GET">/guilds/[\{guild.id\}](/resources/guild#guild-object)/auto-moderation/rules/[\{auto_moderation_rule.id\}](/resources/auto-moderation#auto-moderation-rule-object)</RoutePill>

Get a single rule. Returns an [auto moderation rule](/resources/auto-moderation#auto-moderation-rule-object) object.
...
<RoutePill method="POST">/guilds/[\{guild.id\}](/resources/guild#guild-object)/auto-moderation/rules</RoutePill>

Create a new rule. Returns an [auto moderation rule](/resources/auto-moderation#auto-moderation-rule-object) on success. Fires an [Auto Moderation Rule Create](/topics/gateway-events#auto-moderation-rule-create) Gateway event.
...
|---------------------|-------------------------------------------------------------------------------------|-------------------------------------------------------------------------|
| name                | string                                                                              | the rule name                                                           |
| event_type          | integer                                                                             | the [event type](/resources/auto-moderation#event-types)                |
| trigger_type        | integer                                                                             | the [trigger type](/resources/auto-moderation#trigger-types)            |
| trigger_metadata? * | object                                                                              | the [trigger metadata](/resources/auto-moderation#trigger-metadata)     |
| actions             | array of [action](/resources/auto-moderation#auto-moderation-action-object) objects | the actions which will execute when the rule is triggered               |
| enabled?            | boolean                                                                             | whether the rule is enabled (False by default)                          |
| exempt_roles?       | array of snowflakes                                                                 | the role ids that should not be affected by the rule (Maximum of 20)    |
| exempt_channels?    | array of snowflakes                                                                 | the channel ids that should not be affected by the rule (Maximum of 50) |

\* Can be omitted based on `trigger_type`. See the `Associated Trigger Types` column in [trigger metadata](/resources/auto-moderation#trigger-metadata) to understand which `trigger_type` values require `trigger_metadata` to be set.

:::info
See [Trigger Types](/resources/auto-moderation#trigger-types) for limits on how many rules of each trigger type can be created per guild.
:::

## Modify Auto Moderation Rule

<RoutePill method="PATCH">/guilds/[\{guild.id\}](/resources/guild#guild-object)/auto-moderation/rules/[\{auto_moderation_rule.id\}](/resources/auto-moderation#auto-moderation-rule-object)</RoutePill>

Modify an existing rule. Returns an [auto moderation rule](/resources/auto-moderation#auto-moderation-rule-object) on success. Fires an [Auto Moderation Rule Update](/topics/gateway-events#auto-moderation-rule-update) Gateway event.

:::info
Requires `MANAGE_GUILD` [permissions](/resources/auto-moderation#auto-moderation-permission-requirements).
:::
...
<RoutePill method="DELETE">/guilds/[\{guild.id\}](/resources/guild#guild-object)/auto-moderation/rules/[\{auto_moderation_rule.id\}](/resources/auto-moderation#auto-moderation-rule-object)</RoutePill>

Delete a rule. Returns a `204` on success. Fires an [Auto Moderation Rule Delete](/topics/gateway-events#auto-moderation-rule-delete) Gateway event.
