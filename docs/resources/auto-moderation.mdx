...
```json
{
  ...
  "trigger_type": 1, // TriggerType.KEYWORD
  "event_type": 1, // EventType.MESSAGE_SEND
  "actions": [
    {
      "type": 1, // ActionType.BLOCK_MESSAGE
      "metadata": { "custom_message": "Please keep financial discussions limited to the #finance channel" }
    },
    {
      "type": 2, // ActionType.SEND_ALERT_MESSAGE
      "metadata": { "channel_id": "123456789123456789" }
    },
    {
      "type": 3, // ActionType.TIMEOUT
