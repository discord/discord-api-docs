...
| communication_disabled_until | ?ISO8601 timestamp  | when the user should be able to interact with the guild again (up to 28 days in the future); set to null to remove timeout | KICK_MEMBERS     |
