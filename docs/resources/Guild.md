...
>warn
>This endpoint is limited to 10 active guilds. This limit includes guilds not owned by the bot. Creating channel categories from this endpoint is not supported.
