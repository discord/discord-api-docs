...
| icon        | ?[image data](#DOCS_REFERENCE/image-data) | base64 64x64 png/jpeg image for the role icon (if the guild has the `ROLE_ICONS` feature) | null                           |
...
| icon        | [image data](#DOCS_REFERENCE/image-data) | base64 64x64 png/jpeg image for the role icon (if the guild has the `ROLE_ICONS` feature) |                          |
