...
> warn
> Attempting to omit the `COMMUNITY` feature when it was previously present will fail, unless the bot has `ADMINISTRATOR` permissions. Attempting to add this feature when it was not present beforehand, will also fail for the same reason.
