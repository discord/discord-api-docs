...
| communication_disabled_until? | ?ISO8601 timestamp                              | till when the user is time-outed. This will leave the user completely unable to interact with the server till this time has been reached |
