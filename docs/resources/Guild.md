...
| flags                         | integer                                         | the [members flags](#DOCS_RESOURCES_CHANNEL/member-flags) combined as a bitfield                                                                                                                                                      |
...
| Flag                                   | Value  | Description                                                                       |
|----------------------------------------|--------|-----------------------------------------------------------------------------------|
| DID_REJOIN                             | 1 << 0 | This member has joined and left the guild before                                  |
