...
|-------------------|-----------------------------------------------------------------------------------------------------|-----------------------------------------------------------------|
| question          | [Poll Media Object](/docs/resources/poll#poll-media-object-structure)             | The question of the poll. Only `text` is supported.             |
| answers           | List of [Poll Answer Objects](/docs/resources/poll#poll-answer-object-structure) | Each of the answers available in the poll.                      |
...
| results?          | [Poll Results Object](/docs/resources/poll#poll-results-object-structure)       | The results of the poll                                         |
...
It is similar but not exactly identical to the main [poll object](/docs/resources/poll#poll-object-structure).
...
|-------------------|-----------------------------------------------------------------------------------------------------|------------------------------------------------------------------------------------------|
| question          | [Poll Media Object](/docs/resources/poll#poll-media-object-structure)             | The question of the poll. Only `text` is supported.                                      |
| answers           | List of [Poll Answer Objects](/docs/resources/poll#poll-answer-object-structure) | Each of the answers available in the poll, up to 10                                      |
...
| poll_media  | [Poll Media Object](/docs/resources/poll#poll-media-object-structure) | The data of the answer |
...
| answer_counts | List of [Poll Answer Count Object](/docs/resources/poll#poll-answer-count-object-structure) | The counts for each answer                    |
...
<RoutePill method="GET">/channels/[\{channel.id\}](/docs/resources/channel#channel-object)/polls/[\{message.id\}](/docs/resources/channel#message-object)/answers/[\{answer_id\}](/docs/resources/poll#poll-answer-object)</RoutePill>
...
<RoutePill method="POST">/channels/[\{channel.id\}](/docs/resources/channel#channel-object)/polls/[\{message.id\}](/docs/resources/channel#message-object)/expire</RoutePill>
