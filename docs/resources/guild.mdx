...
| colors        | [role colors object](/docs/topics/permissions#role-colors-object)     | the role's colors (if the guild has bought gradient colors)                                                                    | [default role colors object](/docs/topics/permissions#default-role-colors-object)    |
...
| colors        | [role colors object](/docs/topics/permissions#role-colors-object)    | the role's gradient colors (if the guild has bought gradient colors)                                                           |
