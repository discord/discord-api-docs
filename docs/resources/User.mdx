...
| flags?             | integer   | the [flags](/docs/resources/User#user-flags) on a user's account                         | identify              |
| premium_type?      | integer   | the [type of Nitro subscription](/docs/resources/User#premium-types) on a user's account | identify              |
| public_flags?      | integer   | the public [flags](/docs/resources/User#user-flags) on a user's account                  | identify              |
...
| type          | string  | the [service](/docs/resources/User#services) of this connection        |
...
| visibility    | integer | [visibility](/docs/resources/User#visibility-types) of this connection |
...
<RoutePill method="GET">/users/[\{user.id\}](/docs/resources/User#user-object)</RoutePill>
...
<RoutePill method="GET">/users/@me/guilds/[\{guild.id\}](/docs/resources/Guild#guild-object)/member</RoutePill>
...
<RoutePill method="DELETE">/users/@me/guilds/[\{guild.id\}](/docs/resources/Guild#guild-object)</RoutePill>
...
<RoutePill method="GET">/users/@me/applications/[\{application.id\}](/docs/resources/Application#application-object)/role-connection</RoutePill>
...
<RoutePill method="PUT">/users/@me/applications/[\{application.id\}](/docs/resources/Application#application-object)/role-connection</RoutePill>
