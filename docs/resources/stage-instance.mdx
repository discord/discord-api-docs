...
| privacy_level            | integer    | The [privacy level](/resources/stage-instance#privacy-level) of the Stage instance |
...
- **Moderators**: A member of the guild is a _moderator_ of a Stage channel if they have all of the following [permissions](/topics/permissions):
  - `MANAGE_CHANNELS`
  - `MUTE_MEMBERS`
  - `MOVE_MEMBERS`
...
Creates a new Stage instance associated to a Stage channel. Returns that [Stage instance](/resources/stage-instance#stage-instance-structure). Fires a [Stage Instance Create](/topics/gateway-events#stage-instance-create) Gateway event.
...
| topic                       | string    | The topic of the Stage instance (1-120 characters)                                                      |
| privacy_level?              | integer   | The [privacy level](/resources/stage-instance#privacy-level) of the Stage instance (default GUILD_ONLY) |
...
<RoutePill method="GET">/stage-instances/[\{channel.id\}](/resources/channel#channel-object)</RoutePill>

Gets the stage instance associated with the Stage channel, if it exists.

## Modify Stage Instance

<RoutePill method="PATCH">/stage-instances/[\{channel.id\}](/resources/channel#channel-object)</RoutePill>

Updates fields of an existing Stage instance. Returns the updated [Stage instance](/resources/stage-instance#stage-instance-structure). Fires a [Stage Instance Update](/topics/gateway-events#stage-instance-update) Gateway event.
...
<RoutePill method="DELETE">/stage-instances/[\{channel.id\}](/resources/channel#channel-object)</RoutePill>

Deletes the Stage instance. Returns `204 No Content`. Fires a [Stage Instance Delete](/topics/gateway-events#stage-instance-delete) Gateway event.
