...
| privacy_level            | integer    | The [privacy level](/docs/resources/stage-instance#privacy-level) of the Stage instance |
...
- **Public**: A Stage instance is public when it has a `privacy_level` of `PUBLIC`. While a guild has a public Stage instance:
  - Users in the Stage can have the Stage show in their [activities](/docs/topics/gateway-events#presence).
...
Creates a new Stage instance associated to a Stage channel. Returns that [Stage instance](/docs/resources/stage-instance#stage-instance-structure). Fires a [Stage Instance Create](/docs/topics/gateway-events#stage-instance-create) Gateway event.
...
| topic                       | string    | The topic of the Stage instance (1-120 characters)                                                                                 |
| privacy_level?              | integer   | The [privacy level](/docs/resources/stage-instance#privacy-level) of the Stage instance (default GUILD_ONLY) |
...
Updates fields of an existing Stage instance. Returns the updated [Stage instance](/docs/resources/stage-instance#stage-instance-structure). Fires a [Stage Instance Update](/docs/topics/gateway-events#stage-instance-update) Gateway event.
...
Deletes the Stage instance. Returns `204 No Content`. Fires a [Stage Instance Delete](/docs/topics/gateway-events#stage-instance-delete) Gateway event.
