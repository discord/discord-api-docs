...
| 1 << 13 | GATEWAY_PRESENCE_LIMITED         | Permission required for bots in under 100 servers to receive [`presence_update` events](DOCS_TOPICS_GATEWAY/presence-update) (can be enabled in Bot Settings) |
| 1 << 14 | GATEWAY_GUILD_MEMBERS            | Permission required for bots in **100 or more servers** to receive member-related events like `guild_member_add`. See full list [under `GUILD_MEMBERS`](DOCS_TOPICS_GATEWAY/list-of-intents) |
| 1 << 15 | GATEWAY_GUILD_MEMBERS_LIMITED    | Permission required for bots in under 100 servers to receive member-related events like `guild_member_add` (can be enabled in Bot Settings). See full list [under `GUILD_MEMBERS`](DOCS_TOPICS_GATEWAY/list-of-intents)
...
| 1 << 19 | GATEWAY_MESSAGE_CONTENT_LIMITED  | Permission required for bots in under 100 servers to receive [message content](https://support-dev.discord.com/hc/en-us/articles/4404772028055) (can be enabled in Bot Settings) |
