...
| privacy_level            | integer    | The [privacy level](/docs/resources/Stage_Instance#privacy-level) of the Stage instance |
...
- **Moderators**: A member of the guild is a _moderator_ of a Stage channel if they have all of the following [permissions](/docs/topics/Permissions):
  - `MANAGE_CHANNELS`
  - `MUTE_MEMBERS`
  - `MOVE_MEMBERS`
...
<RoutePill method="POST">/stage-instances</RoutePill>

Creates a new Stage instance associated to a Stage channel. Returns that [Stage instance](/docs/resources/Stage_Instance#stage-instance-structure). Fires a [Stage Instance Create](/docs/topics/Gateway_Events#stage-instance-create) Gateway event.
...
| topic                       | string    | The topic of the Stage instance (1-120 characters)                                                                                 |
| privacy_level?              | integer   | The [privacy level](/docs/resources/Stage_Instance#privacy-level) of the Stage instance (default GUILD_ONLY) |
...
<RoutePill method="GET">/stage-instances/[\{channel.id\}](/docs/resources/Channel#channel-object)</RoutePill>

Gets the stage instance associated with the Stage channel, if it exists.

## Modify Stage Instance

<RoutePill method="PATCH">/stage-instances/[\{channel.id\}](/docs/resources/Channel#channel-object)</RoutePill>

Updates fields of an existing Stage instance. Returns the updated [Stage instance](/docs/resources/Stage_Instance#stage-instance-structure). Fires a [Stage Instance Update](/docs/topics/Gateway_Events#stage-instance-update) Gateway event.
...
<RoutePill method="DELETE">/stage-instances/[\{channel.id\}](/docs/resources/Channel#channel-object)</RoutePill>
