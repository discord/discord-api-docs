...
| roles?          | array of [role](#DOCS_TOPICS_PERMISSIONS/role-object) object ids | roles this emoji is delimited to                                        |
...
| roles | array of snowflakes                      | roles for which this emoji will be delimited to|
...
| ----- | -------------------- | --------------------------------------------- |
| name  | string               | name of the emoji                             |
| roles | ?array of snowflakes | roles to which this emoji will be delimited to|
