...
| type              | integer                                                     | the [type](/resources/webhook#webhook-types) of the webhook                                              |
...
<RoutePill method="POST">/channels/[\{channel.id\}](/resources/channel#channel-object)/webhooks</RoutePill>

Creates a new webhook and returns a [webhook](/resources/webhook#webhook-object) object on success. Requires the `MANAGE_WEBHOOKS` permission. Fires a [Webhooks Update](/topics/gateway-events#webhooks-update) Gateway event.

An error will be returned if a webhook name (`name`) is not valid. A webhook name is valid if:
- It does not contain the substrings `clyde` or `discord` (case-insensitive)
- It follows the nickname guidelines in the [Usernames and Nicknames](/resources/user#usernames-and-nicknames) documentation, with an exception that webhook names can be up to 80 characters
...
<RoutePill method="GET">/channels/[\{channel.id\}](/resources/channel#channel-object)/webhooks</RoutePill>

Returns a list of channel [webhook](/resources/webhook#webhook-object) objects. Requires the `MANAGE_WEBHOOKS` permission.

## Get Guild Webhooks

<RoutePill method="GET">/guilds/[\{guild.id\}](/resources/guild#guild-object)/webhooks</RoutePill>

Returns a list of guild [webhook](/resources/webhook#webhook-object) objects. Requires the `MANAGE_WEBHOOKS` permission.

## Get Webhook

<RoutePill method="GET">/webhooks/[\{webhook.id\}](/resources/webhook#webhook-object)</RoutePill>

Returns the new [webhook](/resources/webhook#webhook-object) object for the given id.

## Get Webhook with Token

<RoutePill method="GET">/webhooks/[\{webhook.id\}](/resources/webhook#webhook-object)/[\{webhook.token\}](/resources/webhook#webhook-object)</RoutePill>

Same as above, except this call does not require authentication and returns no user in the webhook object.

## Modify Webhook

<RoutePill method="PATCH">/webhooks/[\{webhook.id\}](/resources/webhook#webhook-object)</RoutePill>

Modify a webhook. Requires the `MANAGE_WEBHOOKS` permission. Returns the updated [webhook](/resources/webhook#webhook-object) object on success. Fires a [Webhooks Update](/topics/gateway-events#webhooks-update) Gateway event.
...
<RoutePill method="PATCH">/webhooks/[\{webhook.id\}](/resources/webhook#webhook-object)/[\{webhook.token\}](/resources/webhook#webhook-object)</RoutePill>

Same as above, except this call does not require authentication, does not accept a `channel_id` parameter in the body, and does not return a user in the webhook object.

## Delete Webhook

<RoutePill method="DELETE">/webhooks/[\{webhook.id\}](/resources/webhook#webhook-object)</RoutePill>

Delete a webhook permanently. Requires the `MANAGE_WEBHOOKS` permission. Returns a `204 No Content` response on success. Fires a [Webhooks Update](/topics/gateway-events#webhooks-update) Gateway event.
...
<RoutePill method="DELETE">/webhooks/[\{webhook.id\}](/resources/webhook#webhook-object)/[\{webhook.token\}](/resources/webhook#webhook-object)</RoutePill>

Same as above, except this call does not require authentication.

## Execute Webhook

<RoutePill method="POST">/webhooks/[\{webhook.id\}](/resources/webhook#webhook-object)/[\{webhook.token\}](/resources/webhook#webhook-object)</RoutePill>

Refer to [Uploading Files](/reference#uploading-files) for details on attachments and `multipart/form-data` requests. Returns a message or `204 No Content` depending on the `wait` query parameter.
...
| embeds            | array of up to 10 [embed](/resources/channel#embed-object) objects              | embedded `rich` content                                                                                                                                                                         | one of content, file, embeds, poll |
...
| attachments \*\*  | array of partial [attachment](/resources/channel#attachment-object) objects     | attachment objects with filename and description                                                                                                                                                | false                              |
| flags             | integer                                                                         | [message flags](/resources/channel#message-flags) combined as a [bitfield](https://en.wikipedia.org/wiki/Bit_field) (only `SUPPRESS_EMBEDS` and `SUPPRESS_NOTIFICATIONS` can be set can be set) | false                              |
...
| poll              | [poll](/resources/poll#poll-create-request-object) request object               | A poll!                                                                                                                                                                                         | one of content, file, embeds, poll |
...
<RoutePill method="POST">/webhooks/[\{webhook.id\}](/resources/webhook#webhook-object)/[\{webhook.token\}](/resources/webhook#webhook-object)/slack</RoutePill>
...
<RoutePill method="POST">/webhooks/[\{webhook.id\}](/resources/webhook#webhook-object)/[\{webhook.token\}](/resources/webhook#webhook-object)/github</RoutePill>
...
<RoutePill method="GET">/webhooks/[\{webhook.id\}](/resources/webhook#webhook-object)/[\{webhook.token\}](/resources/webhook#webhook-object)/messages/[\{message.id\}](/resources/channel#message-object)</RoutePill>
...
<RoutePill method="PATCH">/webhooks/[\{webhook.id\}](/resources/webhook#webhook-object)/[\{webhook.token\}](/resources/webhook#webhook-object)/messages/[\{message.id\}](/resources/channel#message-object)</RoutePill>
...
| payload_json \*\* | string                                                                          | JSON encoded body of non-file params (multipart/form-data only) |
| attachments \*\*  | array of partial [attachment](/resources/channel#attachment-object) objects     | attached files to keep and possible descriptions for new files  |
...
<RoutePill method="DELETE">/webhooks/[\{webhook.id\}](/resources/webhook#webhook-object)/[\{webhook.token\}](/resources/webhook#webhook-object)/messages/[\{message.id\}](/resources/channel#message-object)</RoutePill>
