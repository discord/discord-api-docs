...
| triggering_interaction_metadata? | [message interaction metadata object](#DOCS_RESOURCES_MESSAGE/message-interaction-metadata-object-message-interaction-metadata-structure)                                                                                                | Metadata for the interaction that was used to open the modal, present only on modal submit interactions                                                                                                             |
