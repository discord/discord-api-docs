...
| username                | string                                                                               | the user's unique username                                                 | identify              |
| discriminator           | string                                                                               | the user's Discord-tag (Depricated, Now always `0`)                                                                               | identify              |
...
| banner_color?                 | ?string                                                                             | the user's banner color as a hexadecimal color code                                           | identify              |
...
| clan?          | ?[user primary guild](/docs/resources/user#user-object-user-primary-guild) object    | See `primary_guild`                                                                             | identify              |
...
| display_name_styles?    | ?[display name styles](/docs/resources/user#) object |data for the users display name style                                                                            | identify              |
| locale    | ?[locale](/docs/reference#locales) object | the users locale settings                                                                            | identify              | 
| phone    | ?string | the current users phone number (`/@me` only)                                                                           | identify              | 
| premium_usage_flags    | integer | the ?[premium_usage_flags](/docs/resources/user#premium-usage-flags) on the account                                                                           | identify              | 
| purchased_flags    | integer | the ?[purchased_flags](/docs/resources/user#purchased-flags) on the account                                                                           | identify              | 
| nsfw_allowed    | ?boolean | the user is allowed to see nsfw content, `null` if not yet known                                                                           | identify              | 
| bio?    | ?string | the user bio                                                                           | identify              | 
| authenticator_types    | array[integer] | 	the ?[multi-factor authentication types](/docs/resources/user#authentication-types) the user has enabled                                                                        | identify              | 
| age_verification_status    | integer | the ?[age verification](/docs/resources/user#age-verification) status of the user                                                                           | identify              | 
...
```json
{
  ...
  "public_flags": 64,
  "flags": 64,
  "banner": "ea2947edda68c2f1812c6def9e59981b",
  "accent_color": 16711680,
  "global_name": "Nelly",
  "avatar_decoration_data": {
    "sku_id": "1144058844004233369",
...
| `1 << 12`     | SYSTEM               | User is a system user (i.e. official Discord account)                     |
...
| `1 << 20 `    | SPAMMER              | User is marked as a spammer                           |
| `1 << 22` | ACTIVE_DEVELOPER         | User is an [Active Developer](https://support-dev.discord.com/hc/articles/10113997751447)                                                      |
| `1 << 23`     | PROVISIONAL_ACCOUNT  | Provisional account for social layer integration      |
...
| `1 << 2`  | NITRO_BASIC              |  User has purchased Nitro basic           |
| `1 << 2`  | ON_REVERSE_TRIAL         |  User has a reverse trial active          |
