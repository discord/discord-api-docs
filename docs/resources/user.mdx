...
| clan?                       | ?[user primary guild](/docs/resources/user#user-object-user-primary-guild) object    | Replaced by `primary_guild`, but still currently visible                                                   | identify              |
...
\* Only available from the `users/@me` endpoint
