...
| PIN_PERMISSION_MIGRATION_COMPLETE           | 212   | Guild completed Pin Messages permission migration         |                                                                                                                                                  |
| BYPASS_SLOWMODE_PERMISSION_MIGRATION_COMPLETE | 213   | Guild completed Bypass Slowmode permission migration    |                                                                                                                                                  |
