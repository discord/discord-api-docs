...
| bot? | bool | present and true if the user belongs to an OAuth2 application | identify |
| mfa_enabled? | bool | present and true if the user has two factor enabled on their account | identify |
