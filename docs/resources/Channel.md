...
| enforce_nonce?     | boolean                                                                                           | If true and nonce is present, will be checked for uniqueness in the past few minutes. If another message was created by the same author, that message will be returned and no new message will be created. |
