...
| permission_overwrites | ?array of [partial overwrite](#DOCS_RESOURCES_CHANNEL/partial-overwrite-structure) objects | channel or category-specific permissions                                                                                                                                        | All                      |
