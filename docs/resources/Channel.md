...
| components? | [component](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS) object | sent if the message contains components like buttons, action rows, or other interactive components |
