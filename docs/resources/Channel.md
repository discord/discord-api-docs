...
| message_count?                      | integer                                                                     | number of messages (not including the initial message or deleted messages) in a thread (only increments past 50 for messages sent after July 1, 2022)                                         |
