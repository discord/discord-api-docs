...
| activity? | [message activity](#DOCS_CHANNEL/message-object-message-activity-structure) object | sent with Rich Presence-related chat embeds |
| application? | [message application](#DOCS_CHANNEL/message-object-message-application-structure) object | sent with Rich Presence-related chat embeds | |
...
| Field | Type | Description |
| ----- | ---- | ----------- |
| type | int | [type of message activity](#DOCS_CHANNEL/message-object-message-activity-types) |
| party\_id? | string | party_id from a [Rich Presence event](#DOCS_HOW_TO/updating-presence-update-presence-payload-fields) |
