...
| sticker_items?\*\*\*\*\*\* | Array of [message `sticker_item` objects](#DOCS_RESOURCES_CHANNEL/message-object-message-sticker_items-structure) | sent if the message contains stickers |
...
###### Message `sticker_items` Structure

A `sticker_item` object is the smallest amount of data required to render a sticker.
