...
| reactions | array of [reaction objects](#DOCS_CHANNEL/reaction-objects) | reactions to the message |
...
Delete a reaction for the message the current user has made. Returns a 204 empty response on success.
