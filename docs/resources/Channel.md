...
| interaction_metadata?       | [message interaction metadata object](#DOCS_RESOURCES_CHANNEL/interaction-metadata-object-message-metadata-structure)              | sent if the message is sent as a result of an [interaction](#DOCS_INTERACTIONS_RECEIVING_AND_RESPONDING/)                                                                                                                                                                     |
