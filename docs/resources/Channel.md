...
| default_sort_order?                 | integer                                                                     | the [default sort order mode](#DOCS_RESOURCES_CHANNEL/sort-order-modes) used to order posts inside channels of type                                                                           |
...
| default_sort_order                  | integer                                                                         | the [default sort order mode](#DOCS_RESOURCES_CHANNEL/sort-order-modes) used to order posts inside channels of type                                                                | Forum                            |
