...
| default_sort_order?                 | integer                                                                     | the [default sort order mode](#DOCS_RESOURCES_CHANNEL/channel-object-sort-order-modes) used to order posts in `GUILD_FORUM` channels                                                          |
...
| default_sort_order                  | integer                                                                         | the [default sort order mode](#DOCS_RESOURCES_CHANNEL/channel-object-sort-order-modes) used to order posts in `GUILD_FORUM` channels                                               | Forum                            |
