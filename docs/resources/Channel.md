...
| default_sort_order?                 | ?integer                                                                    | the [default sort order type](#DOCS_RESOURCES_CHANNEL/channel-object-sort-order-types) used to order posts in a `GUILD_FORUM` channel. Defaults to `null`, which indicates a preferred sort order hasn't been set by a channel admin |
| default_forum_layout?               | integer                                                                     | the [default layout type](#DOCS_RESOURCES_CHANNEL/channel-object-forum-layout-types) used to display posts in a `GUILD_FORUM` channel.                                                                                               |
...
| Type    | Value | Description                                                  |
| ------- | ----- | ------------------------------------------------------------ |
| DEFAULT | 0     | A preferred forum layout hasn't been set by a server admin   |
| LIST    | 1     | List View: display forum posts in a text-focused list        |
| GRID    | 2     | Gallery View: display forum posts in a media-focused gallery |    
...
| default_sort_order?                 | ?integer                                                                        | the [default sort order type](#DOCS_RESOURCES_CHANNEL/channel-object-sort-order-types) used to order posts in a `GUILD_FORUM` channel                                                          | Forum                            |
| default_forum_layout?               | integer                                                                         | the [default layout type](#DOCS_RESOURCES_CHANNEL/channel-object-forum-layout-types) used to display posts in a `GUILD_FORUM` channel                                                          | Forum                            |
