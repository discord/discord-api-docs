...
| GUILD_VOICE             | 2   | a voice channel within a server, can be a text-based channel                                                                                                                      |
...
> warn
> Text in Voice: Guild Voice channels can also contain a chat, and will be considered text-based channels, but do not support threads and pinned messages, this is an example:
