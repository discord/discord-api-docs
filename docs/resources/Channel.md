...
| interaction_metadata?       | [message interaction metadata object](#TODO)                                                                                       | sent if the message is a response to an [Interaction](#DOCS_INTERACTIONS_RECEIVING_AND_RESPONDING/)                                                                                                                                                                     |
...
| name?                            | string                                                                                                                                | Name of the command, present only on messages created from command invocations                                                                                                                                      |
