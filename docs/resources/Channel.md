...
| stickers?                 | array of [sticker](#DOCS_RESOURCES_CHANNEL/sticker-object) objects                                                                              | array of stickers sent in this message                                                                                         |
...
| pack_id      | snowflake                                                                                  | id of the pack the sticker belongs to                                                                |
| name         | string                                                                                     | name of string                                                                                       |      
| description  | string                                                                                     | description of sticker                                                                               |
| asset?       | string                                                                                     | asset hash of the sticker                                                                            |
| format_type? | integer                                                                                    | asset type of the sticker                                                                            |
| tags?        | string                                                                                     | tags of the sticker                                                                                  |                                                                              

###### Sticker Format Types

Sticker format types describe the image format that the asset is in.
