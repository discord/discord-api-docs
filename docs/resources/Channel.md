...
| message_reference?        | [message reference](#DOCS_RESOURCES_CHANNEL/message-reference-object) object                                                                    | data showing the source of a crosspost, channel follow add, or pin message                                                    |
...
There are three situations in which a message has a message_reference object:
