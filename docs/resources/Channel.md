...
| message_reference?        | [message reference](#DOCS_RESOURCES_CHANNEL/message-reference-object) object                                                                    | data showing the source of a crosspost, channel follow add, pin, or reply message                                                       |
