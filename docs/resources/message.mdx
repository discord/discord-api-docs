...
| thumbnail?   | [embed image](/docs/resources/message#embed-object-embed-image-structure) object           | thumbnail information                                                                                                             |
...
| flags?       | integer                                                                                    | [embed flags](/docs/resources/message#embed-object-embed-flags) combined as a [bitfield](https://en.wikipedia.org/wiki/Bit_field) |
...
| flags?               | integer | [embed media flags](/docs/resources/message#embed-object-embed-media-flags) combined as a [bitfield](https://en.wikipedia.org/wiki/Bit_field) |
...
| clip_participants? | array of [user](/docs/resources/user#user-object) objects      | for Clips, array of users who were in the stream                                                                                                 |
| clip_created_at?   | ISO8601 timestamp                                              | for Clips, when the clip was created                                                                                                             |
| application?       | ?[application](/docs/resources/application#application-object) | for Clips, the application in the stream, if recognized                                                                                          |
