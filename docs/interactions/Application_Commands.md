...
| Name              | Value | Description                                                                                                                         |
| ----------------- | ----- | ----------------------------------------------------------------------------------------------------------------------------------- |
| SUB_COMMAND       | 1     | A subcommand option, can be contained within a subcommand group; you can have both a subcommand and a subcommand group in a command |
| SUB_COMMAND_GROUP | 2     | A subcommand group, contains subcommands; but can not and never will contain subcommand groups                                      |
| STRING            | 3     | A string input                                                                                                                      |
| INTEGER           | 4     | Any integer between -2^53 and 2^53                                                                                                  |
| BOOLEAN           | 5     | A boolean input of true/false                                                                                                       |
| USER              | 6     | A user input, only users of the server are shown in the UI but you may paste an ID which will be rssolved and sent to the bot       |
| CHANNEL           | 7     | Includes all channel types + categories                                                                                             |
| ROLE              | 8     | A role from the server which the command is being invoked from, you can paste an ID, but it must be from the server itself          |
