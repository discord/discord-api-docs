...
| nsfw?                       | ?boolean                                                                                                                                       | Indicates whether the command is marked as NSFW, defaults to `false`                                                                                               | all         |
...
| nsfw?                       | ?boolean                                                                                                                                       | Indicates whether the command is marked as NSFW, defaults to `false`                                                                                                |
