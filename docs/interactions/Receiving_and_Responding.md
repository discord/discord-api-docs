...
| --------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------------------------------------- |
| id              | snowflake                                                                                                                                                                                                  | the [`ID`](#DOCS_INTERACTIONS_APPLICATION_COMMANDS/application-command-object-application-command-structure) of the invoked command                                                   | Application Command, Application Command Autocomplete                                                                                              |
| name            | string                                                                                                                                                                                                     | the [`name`](#DOCS_INTERACTIONS_APPLICATION_COMMANDS/application-command-object-application-command-structure) of the invoked command                                                 | Application Command, Application Command Autocomplete                                                                                              |
| type            | integer                                                                                                                                                                                                    | the [`type`](#DOCS_INTERACTIONS_APPLICATION_COMMANDS/application-command-object-application-command-structure) of the invoked command                                                 | Application Command, Application Command Autocomplete                                                                                              |
...
| options?        | array of [application command autocomplete interaction data option](#DOCS_INTERACTIONS_APPLICATION_COMMANDS/application-command-object-application-command-autocomplete-interaction-data-option-structure) | the params + values from the user                                                                                                                                                     | Application Command Autocomplete                                                                                                                   |
...
\*\* Only valid for [application-command-based](#DOCS_INTERACTIONS_APPLICATION_COMMANDS/) interactions
...
| choices?          | array of [choices](#DOCS_INTERACTIONS_APPLICATION_COMMANDS/application-command-option-choice-structure) | autocomplete choises (limited to 25 choices)                                                                                               |
