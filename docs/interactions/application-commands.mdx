...
json = {
    "name": "blep",
    "type": 1, # InteractionType.CHAT_INPUT
    "description": "Send a random adorable animal photo",
    "options": [
        {
            "name": "animal",
            "description": "The type of animal",
            "type": 3, # InteractionOptionType.STRING
            "required": True,
            "choices": [
                {
                    "name": "Dog",
        ...
        },
        {
            ...
            "type": 5, # InteractionOptionType.BOOLEAN
            "required": False
        }
    ]
}
    ...
    "permissions": [
        {
            ...
            "type": 3, # InteractionType.CHANNEL
            "permission": False
        }
    ]
}
    ...
    "options": [
        {
            ...
            "type": 2 // InteractionOptionType.SUB_COMMAND_GROUP
        },
        {
            "name": "role",
            ...
            "options": [
                {
                    ...
                    "type": 1 // InteractionOptionType.SUB_COMMAND
                },
                {
                    "name": "edit",
                    ...
                    "options": [
                        {
                            ...
                            "type": 6, // InteractionOptionType.USER
                            "required": true
                        },
                        {
                            "name": "channel",
                            "description": "The channel permissions to get. If omitted, the guild permissions will be returned",
                            "type": 7, // InteractionOptionType.CHANNEL
                            "required": false
                        }
                    ]
                },
                    ...
                    "options": [
                        {
                            ...
                            "type": 8, // InteractionOptionType.ROLE
                            "required": true
                        },
                        {
                            "name": "channel",
...
{
    "name": "Bookmark",
    "type": 3 // InteractionType.MESSAGE
}
```
...
```json
{
    ...
    "type": 4, // InteractionType.APPLICATION_COMMAND_ENTRY_POINT
    "handler": 2 // ApplicationCommandEntryPointHandler.DISCORD_LAUNCH_ACTIVITY
}
```
...
```json
{
  ...
  "options": [
    {
      "name": "age",
      "type": 4, // InteractionOptionType.INTEGER
