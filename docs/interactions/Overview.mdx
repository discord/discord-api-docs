...
**[Modals](/docs/interactions/Receiving_and_Responding#modal)** are single-user pop-up interfaces that allow apps to collect form-like data. Modals can only be opened in response to a user invoking on of your app's commands or message components.
...
Details about creating and using modals is in the [Receiving and Responding](/docs/interactions/Receiving_and_Responding#modal) documentation.
