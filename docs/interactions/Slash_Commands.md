...
> info
> Check out our [Community Resources](../topics/Community_Resources.md#interactions) for libraries to help you with security in your language of choice
...
We highly recommend checking out our [Community Resources](../topics/Community_Resources.md#interactions) and the two libraries found there. They not only provide typing for Interactions data models, but also include decorators for API frameworks like Flask and Express to make validation easy.
...
| allowed_mentions? | allowed mentions | [allowed mentions](../resources/Channel.md#allowed-mentions-object) object                  |
