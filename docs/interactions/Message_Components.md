...
| label? *     | string                                                                                                      | text that appears on the button, max 80 characters; the label for the text input          | [Buttons](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/buttons), [Text Inputs](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/text-inputs)           |
...
| placeholder? | string                                                                                                      | custom placeholder text if nothing is selected, max 100 characters                        | [Select Menus](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/select-menus), [Text Inputs](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/text-inputs) |
...
\* `label` is optional for [buttons](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/buttons), but required for [text inputs](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/text-inputs)
###### Component Types
