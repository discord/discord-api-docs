...
| placeholder? | string                                                                                                      | custom placeholder text if nothing is selected, max 100 characters                        | [Select Menus](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/select-menus) and [Input Text](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/input-text)                                                                                                                                 |
