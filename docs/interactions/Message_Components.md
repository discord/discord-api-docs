...
| custom_id?   | string                                                                                                      | a developer-defined identifier for the component, max 100 characters                      | [Buttons](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/buttons), [Select Menus](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/select-menus) and [Interaction Callback Type Modal](#DOCS_INTERACTIONS_RECEIVING_AND_RESPONDING/interaction-response-object-interaction-callback-type) |
...
| style?       | integer                                                                                                     | one of [button styles](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/button-object-button-styles) | [Buttons](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/buttons) and [Input Text](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/input-text)                                                                                                                                           |
| label?       | string                                                                                                      | text that appears on the button, max 80 characters                                        | [Buttons](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/buttons) and [Input Text](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/input-text)                                                                                                                                           |
...
| title?       | string                                                                                                      | title of modal                                                                            | [Interaction Callback Type Modal](#DOCS_INTERACTIONS_RECEIVING_AND_RESPONDING/interaction-response-object-interaction-callback-type)                                                                                                                                  |
| min_length?  | int                                                                                                         | the minimum length of the text input                                                      | [Input Text](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/input-text)                                                                                                                                                                                                        |
| max_length?  | int                                                                                                         | the maximum length of the text input                                                      | [Input Text](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/input-text)                                                                                                                                                                                                        |
| placeholder? | string                                                                                                      | the placeholder for the text input field                                                  | [Input Text](#DOCS_INTERACTIONS_MESSAGE_COMPONENTS/input-text)                                                                                                                                                                                                         |
...
| placeholder? | string  | a developer-defined placeholder for the text input                                                    |
| min_length?  | int     | minimal length oftext input                                                                           |
