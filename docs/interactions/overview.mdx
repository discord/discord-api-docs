...
![Command launcher in the Desktop client](overview-command-desktop.webp)
...
- **Entry Point commands** are commands used as the primary way to launch [Activities](#DOCS_ACTIVITIES_OVERVIEW) from the App Launcher.
...
![Button message components in a message](overview-components.webp)
...
![Modals in the Discord client](overview-modals.webp)
...
A **Interactions Endpoint URL** is a public endpoint for your app where Discord can send your app HTTP-based interactions. If your app is using [Gateway](#DOCS_EVENTS_GATEWAY)-based interactions, you don't need to configure an Interactions Endpoint URL.
