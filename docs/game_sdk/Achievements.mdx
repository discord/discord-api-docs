...
<RoutePill method="GET">/applications/[\{application.id\}](/docs/game_sdk/Getting_Started#get-set-up)/achievements</RoutePill>
...
<RoutePill method="GET">/applications/[\{application.id\}](/docs/game_sdk/Getting_Started#get-set-up)/achievements/[\{achievement.id\}](/docs/game_sdk/Achievements#achievement-struct)</RoutePill>
...
<RoutePill method="POST">/applications/[\{application.id\}](/docs/game_sdk/Getting_Started#get-set-up)/achievements</RoutePill>
...
<RoutePill method="PATCH">/applications/[\{application.id\}](/docs/game_sdk/Getting_Started#get-set-up)/achievements/[\{achievement.id\}](/docs/game_sdk/Achievements#achievement-struct)</RoutePill>
...
<RoutePill method="DELETE">/applications/[\{application.id\}](/docs/game_sdk/Getting_Started#get-set-up)/achievements/[\{achievement.id\}](/docs/game_sdk/Achievements#achievement-struct)</RoutePill>
...
<RoutePill method="PUT">/users/[\{user.id\}](/docs/resources/User#user-object)/applications/[\{application.id\}](/docs/game_sdk/Getting_Started#get-set-up)/achievements/[\{achievement.id\}](/docs/game_sdk/Achievements#achievement-struct)</RoutePill>
...
<RoutePill method="GET">/users/@me/applications/[\{application.id\}](/docs/game_sdk/Getting_Started#get-set-up)/achievements</RoutePill>
