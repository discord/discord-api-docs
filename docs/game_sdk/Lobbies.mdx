...
<RoutePill method="PATCH">/lobbies/[\{lobby.id\}](/docs/game_sdk/Lobbies#lobby-struct)</RoutePill>
...
<RoutePill method="DELETE">/lobbies/[\{lobby.id\}](/docs/game_sdk/Lobbies#lobby-struct)</RoutePill>

Deletes a lobby.

## Update Lobby Member

<RoutePill method="PATCH">/lobbies/[\{lobby.id\}](/docs/game_sdk/Lobbies#lobby-struct)/members/[\{user.id\}](/docs/resources/User#user-object)</RoutePill>
...
<RoutePill method="POST">/lobbies/[\{lobby.id\}](/docs/game_sdk/Lobbies#lobby-struct)/send</RoutePill>
