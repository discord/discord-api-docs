...
<RoutePill method="GET">/applications/[\{application.id\}](/docs/game_sdk/Getting_Started#get-set-up)/entitlements</RoutePill>
...
| with_payments? | bool                              | returns [limited payment data](/docs/game_sdk/Store#limited-payment-data-object) for each entitlement |
...
<RoutePill method="GET">/applications/[\{application.id\}](/docs/game_sdk/Getting_Started#get-set-up)/entitlements/[\{entitlement.id\}](/docs/game_sdk/Store#entitlement-struct)</RoutePill>
...
| name          | type | description                                                                                                                    |
|---------------|------|--------------------------------------------------------------------------------------------------------------------------------|
| with_payment? | bool | returns [limited payment data](/docs/game_sdk/Store#limited-payment-data-object) for each entitlement |
...
<RoutePill method="GET">/applications/[\{application.id\}](/docs/game_sdk/Getting_Started#get-set-up)/skus</RoutePill>
...
<RoutePill method="POST">/applications/[\{application.id\}](/docs/game_sdk/Getting_Started#get-set-up)/entitlements/[\{entitlement.id\}](/docs/game_sdk/Store#entitlement-struct)/consume</RoutePill>
...
<RoutePill method="DELETE">/applications/[\{application.id\}](/docs/game_sdk/Getting_Started#get-set-up)/entitlements/[\{entitlement.id\}](/docs/game_sdk/Store#entitlement-struct)</RoutePill>
...
<RoutePill method="PUT">/store/skus/[\{sku.id\}](/docs/game_sdk/Store#sku-struct)/discounts/[\{user.id\}](/docs/resources/User#user-object)</RoutePill>
...
<RoutePill method="DELETE">/store/skus/[\{sku.id\}](/docs/game_sdk/Store#sku-struct)/discounts/[\{user.id\}](/docs/resources/User#user-object)</RoutePill>
