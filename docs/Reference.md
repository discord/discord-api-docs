...
| Internal worker ID | 22 to 17 | 5 bits | | ``(snowflake & 3E0000) >> 17`` |
| Internal process ID | 17 to 12 | 5 bits | | ``(snowflake & 0x1F000) >> 12`` |
| Increment | 12 to 0 | 10 bits | For every Id that is generated on that process, this number is incremented | ``(snowflake & 0xFFF) >> 12`` |
