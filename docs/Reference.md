...
| Application Icon       | app-icons/[application_id](#DOCS_TOPICS_APPLICATION/application-object)/[icon](#DOCS_TOPICS_APPLICATION/application-object).png                                                                                                                                | PNG, JPEG, WebP      |
| Application Cover      | app-icons/[application_id](#DOCS_TOPICS_APPLICATION/application-object)/[cover_image](#DOCS_TOPICS_APPLICATION/application-object).png                                                                                                                         | PNG, JPEG, WebP      |
| Application Asset      | app-assets/[application_id](#DOCS_TOPICS_APPLICATION/application-object)/[asset_id](#DOCS_TOPICS_GATEWAY/activity-object-activity-assets).png                                                                                                                  | PNG, JPEG, WebP      |
| Achievement Icon       | app-assets/[application_id](#DOCS_TOPICS_APPLICATION/application-object)/achievements/[achievement_id](#DOCS_GAME_SDK_ACHIEVEMENTS/data-models-user-achievement-struct)/icons/[icon_hash](#DOCS_GAME_SDK_ACHIEVEMENTS/data-models-user-achievement-struct).png | PNG, JPEG, WebP      |
