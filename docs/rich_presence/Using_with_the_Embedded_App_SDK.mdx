...
Now let's take a look at what custom Rich Presence data you can set when updating a user's presence. The [types for these fields](#DOCS_RICH_PRESENCE_USING_THE_EMBEDDED_APP_SDK/setactivity-fields) and [examples](#DOCS_RICH_PRESENCE_USING_THE_EMBEDDED_APP_SDK/example) are in the sections below, but for now let's just get an idea of what we're working with:
