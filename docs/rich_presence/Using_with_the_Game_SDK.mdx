...
The [Game SDK](#DOCS_DEVELOPER_TOOLS_GAME_SDK) helps you build your 3rd party game, and integrate it with Discord. One of its specialties is making it easy to bring your game's data to Discord using [Rich Presence](#DOCS_RICH_PRESENCE_OVERVIEW), which is what this guide will cover.
