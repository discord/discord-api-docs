...
As part of our ongoing effort to help you build your game community, all [Community servers](https://dis.gd/communityservers) (along with [Verified](https://discord.com/verification) and [Developer License](docs/game-and-server-management/how-to-get-your-game-on-discord#your-server-your-kingdom) servers) have the ability to create Announcement Channels!
