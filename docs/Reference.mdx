...
| Sticker Pack Banner         | app-assets/[application_id](#DOCS_RESOURCES_APPLICATION/application-object)/store/[sticker_pack_banner_asset_id](#DOCS_RESOURCES_STICKER/sticker-pack-object).png                                                                                                                                                                                                             | PNG, JPEG, WebP      |
