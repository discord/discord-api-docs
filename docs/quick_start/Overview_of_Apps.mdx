...
Using the [Embedded App SDK](#TODO), apps can create **[Activities](#TODO)** which are interactive, multiplayer games and social experiences in Discord. Activities are cross-platform and embedded within iframes in Discord, where people who play games are already hanging out.
...
<Container>
  ...
  <Card title="Explore developer tools" link="#open-invite-dialog">
