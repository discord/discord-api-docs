...
The installation context of an app can be limited by the developer when [configuring the app](#TODO), and by the user installing the app when going through the installation flow. Details about installation contexts are in the [application resource documentation](#DOCS_RESOURCES_APPLICATION/installation-context).
