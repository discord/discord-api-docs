...
| color?       | number \| null                                                                |
| footer?      | [EmbedFooter](#DOCS_DEVELOPER_TOOLS_EMBEDDED_APP_SDK/embedfooter) \| null     |
| image?       | Image \| null                                                                 |
| thumbnail?   | Image \| null                                                                 |
| video?       | Video \| null                                                                 |
| provider?    | [EmbedProvider](#DOCS_DEVELOPER_TOOLS_EMBEDDED_APP_SDK/embedprovider) \| null |
| author?      | [EmbedAuthor](#DOCS_DEVELOPER_TOOLS_EMBEDDED_APP_SDK/embedauthor) \| null     |
| fields?      | [EmbedField](#DOCS_DEVELOPER_TOOLS_EMBEDDED_APP_SDK/embedfield)[] \| null     |
...
| name?           | string \| null                                              |
| roles?          | string[] \| null                                            |
| user?           | [User](#DOCS_DEVELOPER_TOOLS_EMBEDDED_APP_SDK/user) \| null |
...
| reactions?        | [Reaction](#DOCS_DEVELOPER_TOOLS_EMBEDDED_APP_SDK/reaction)[] \| null     |
| nonce?              | string | number \| null                                                                 |
| pinned              | boolean                                                                                 |
| webhook_id?         | string \| null                                                                          |
| type                | number                                                                                  |
| activity?           | [MessageActivity](#DOCS_DEVELOPER_TOOLS_EMBEDDED_APP_SDK/messageactivity) \| null       |
...
| referenced_message? | [Message](#DOCS_DEVELOPER_TOOLS_EMBEDDED_APP_SDK/message) \| null                       |
