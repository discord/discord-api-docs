...
Welcome to the Discord Game SDK! We're glad you made it. The Game SDK helps you develop your game, and integrate it with Discord.

> danger
> Many Game SDK features—including Achievements, Applications, Voice, Images, Lobbies, Networking, Storage, Store (purchases and discounts), and selling SKUs— have been deprecated. This page contains managers that aren't deprecated, but **are not being actively developed**. 
