...
At a high level, the Discord GameSDK has a class, `Discord`.

This class is in charge of the creation of a few "manager" sub-classes which contain their own functions and events used to interact with Discord in the context of the manager.
...
| [`UserManager`](#DOCS_DEVELOPER_TOOLS_GAME_SDK/user)                  | for fetching user data for a given id and the current user                                  |
...
> danger
> Selling SKUs and the purchase and discount features are deprecated. Some documentation has been removed to reflect this, but the old documentation in full can be viewed at TODO: link to old store docs
...
The following are HTTP requests, and should be handled by your game server (rather than a client). You can refer to the [reference documentation](#DOCS_TOPICS_REFERENCE/authentication) for information on authenticating HTTP requests using your app's bot token.
...
| with_payments? | [boolean](#DOCS_REFERENCE/boolean-query-strings) | returns [limited payment data](#DOCS_DEVELOPER_TOOLS_GAME_SDK/limited-payment-data-objectt) for each entitlement |
...
[Achievements Manager documentation on GitHub](#TODO)
...
[Application Manager documentation on GitHub](#TODO)
...
[Voice Manager documentation on GitHub](#TODO)
...
[Image Manager documentation on GitHub](#TODO)
...
[Lobby Manager documentation on GitHub](#TODO)
...
[Networking Manager docs on GitHub](#TODO)
...
[Storage Manager documentation on GitHub](#TODO)
