...
- "Use Public Threads" is now "Create Public Threads", which allows users to create public or announcement threads in a channel, even if they cannot send messages in that channel.
