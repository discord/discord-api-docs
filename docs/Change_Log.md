...
> warn
> We have removed the default option for voice gateway version - once this is deprecated you must pass a voice gateway version. This deprecation will take effect as of November 18th, 2024. See [Voice Gateway Versioning](#DOCS_TOPICS_VOICE_CONNECTIONS/voice-gateway-versioning) for futher details.
...
> warn
> We are officially deprecating some very old voice gateway versions (> 7 years ago). Deprecated voice gateway versions will be discontinued as of November 18th, 2024. See [Voice Gateway Versioning](#DOCS_TOPICS_VOICE_CONNECTIONS/voice-gateway-versioning) for futher details.
