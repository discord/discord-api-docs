...
| Nameplate Static Asset      | assets/collectibles/[nameplate_asset](/docs/resources/user#nameplate-nameplate-structure) + static.png \*\*\*                                                                                                                                                                                                                                                                 | PNG                        |
| Nameplate Animated Asset    | assets/collectibles/[nameplate_asset](/docs/resources/user#nameplate-nameplate-structure) + asset.webm \*\*\*                                                                                                                                                                                                                                                                 | WebM                       |
