...
3. Using basic authentication with a client ID and client secret found on the **OAuth2** page within your app's settings in the format `client_id:client_secret` as a Base64 encoded string. Only applicable for the [OAuth2 API](/docs/topics/oauth2) token endpoints.
