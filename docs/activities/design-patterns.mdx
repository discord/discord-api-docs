...
- See the below [Quality & Testing Recommendations](/activities/design-patterns#quality-and-testing) for key areas of minimum quality support and testing recommendations.
- See the below [Technical Considerations](/activities/design-patterns#technical-considerations) for recommendations on how to partition loading and work with various development tools to reduce load times.
