...
If this is your first time learning about Activities, check out the [Activities Overview](/activities/overview) for more information and a collection of sample apps.

### Let's Jump In!

For your first Activity, we'll be building an app in JavaScript with the following goals:
- [Create a new Discord App](/activities/building-an-activity#step-1-creating-a-new-app)
- [Launch your app from within a voice channel](/activities/building-an-activity#step-4-running-your-app-locally-in-discord)
- [Authorize and authenticate with the user](/activities/building-an-activity#step-5-authorizing--authenticating-users)
- [Fetch and display the name of the current voice channel](/activities/building-an-activity#step-6-use-the-sdk-to-fetch-the-channel)
- [Fetch and display the avatar of the current server](/activities/building-an-activity#step-7-use-the-api-to-fetch-the-guild)

![Building Your First Activity Tutorial](/images/activities/tutorial-hero.png)

:::info
This example is intended to illustrate how a basic web application works while embedded inside of Discord. For more advanced examples, please see our [Sample Projects](/activities/overview#sample-projects).
:::
...
The [Embedded App SDK](/developer-tools/embedded-app-sdk) is intended to abstract away some of the complexities in building a Discord Activity, but developing a full-featured, multiplayer experience requires extensive experience with JavaScript and other web technologies.
...
:::info
During the Developer Preview, it is recommended you create a new app for testing purposes. There are [limitations for Activities](/activities/overview#public-developer-preview) during this preview period.
:::
...
To use Discord-related information, such as a user's username, avatar, or guild avatar, a user must agree to grant OAuth scopes to your application. Learn more about scopes [in the OAuth2 documentation](/topics/oauth2#oauth2-scopes).

There are two OAuth2 identifiers your app will need to reference: [CLIENT ID](/activities/building-an-activity#client-id) and [CLIENT SECRET](/activities/building-an-activity#client-secret), which are located on the `Settings -> OAuth2` tab on the developer portal.
...
Read more about the specific rules and details for URL mapping [here](/activities/development-guides#url-mapping).
...
:::info
**Customizing your Activity** <br/> If you'd like to set images for your Activity, you can learn how to do that [here](/activities/development-guides#setting-up-activity-metadata).
:::
...
We can now run our server and client-side apps in separate terminal windows. You can see other ways to set this up in our [Sample Projects](/activities/overview#sample-projects).
...
You can now explore our more extensive [development guides](/activities/development-guides) and [design patterns](/activities/design-patterns) to consider when building your app.
