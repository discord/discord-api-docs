...
Whether you're developing a multiplayer game, a new social experience, or another creative idea, your Activity will be built with the [Embedded App SDK](/docs/developer-tools/embedded-app-sdk). The SDK handles all of the communication between Discord and your app, making it easier to do common tasks like managing connected users, supporting mobile clients, and debugging your Activity.
...
<Container>
  ...
  <Card title="Common Development Patterns" link="/docs/activities/development-guides">
