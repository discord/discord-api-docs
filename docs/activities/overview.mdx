...
Whether you're developing a multiplayer game, a new social experience, or another creative idea, your Activity will be built with the [Embedded App SDK](/developer-tools/embedded-app-sdk). The SDK handles all of the communication between Discord and your app, making it easier to do common tasks like managing connected users, supporting mobile clients, and debugging your Activity.
...
<Container>
  <Card title="How Activities Work" link="/activities/how-activities-work">
    Learn more about how Activities are run in Discord.
  </Card>
  <Card title="Build Your First Discord Activity" link="/activities/Building_an_Activity">
    Get started building an Activity using the Embedded App SDK.
  </Card>
  <Card title="Common Development Patterns" link="/activities/development-guides">
