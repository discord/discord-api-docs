...
![Example of default Rich Presence data for an Activity](default-presence-activities.webp)
...
![Image of where Rich Presence data appears in Discord profiles for Activities](annotated-presence-data-activities.webp)
...
![Example of a fake game's Rich Presence data](activities-presence-example.webp)
