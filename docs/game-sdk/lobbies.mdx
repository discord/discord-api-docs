...
<RoutePill method="POST">/lobbies</RoutePill>

Creates a new lobby. Returns an object similar to the SDK `Lobby` struct, documented below.

To get a list of valid regions, call the [List Voice Regions](/resources/voice#list-voice-regions) endpoint.
...
<RoutePill method="PATCH">/lobbies/[\{lobby.id\}](/game-sdk/lobbies#lobby-struct)</RoutePill>
...
<RoutePill method="DELETE">/lobbies/[\{lobby.id\}](/game-sdk/lobbies#lobby-struct)</RoutePill>

Deletes a lobby.

## Update Lobby Member

<RoutePill method="PATCH">/lobbies/[\{lobby.id\}](/game-sdk/lobbies#lobby-struct)/members/[\{user.id\}](/resources/user#user-object)</RoutePill>
...
<RoutePill method="POST">/lobbies/search</RoutePill>
...
<RoutePill method="POST">/lobbies/[\{lobby.id\}](/game-sdk/lobbies#lobby-struct)/send</RoutePill>
