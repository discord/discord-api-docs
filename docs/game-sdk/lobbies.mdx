...
<RoutePill method="PATCH">/lobbies/[\{lobby.id\}](/docs/game-sdk/lobbies#lobby-struct)</RoutePill>
...
<RoutePill method="DELETE">/lobbies/[\{lobby.id\}](/docs/game-sdk/lobbies#lobby-struct)</RoutePill>

Deletes a lobby.

## Update Lobby Member

<RoutePill method="PATCH">/lobbies/[\{lobby.id\}](/docs/game-sdk/lobbies#lobby-struct)/members/[\{user.id\}](/docs/resources/user#user-object)</RoutePill>
...
<RoutePill method="POST">/lobbies/[\{lobby.id\}](/docs/game-sdk/lobbies#lobby-struct)/send</RoutePill>
