...
<RoutePill method="GET">/applications/[\{application.id\}](/docs/game-sdk/getting-started#get-set-up)/entitlements</RoutePill>
...
| with_payments? | bool                              | returns [limited payment data](/docs/game-sdk/store#limited-payment-data-object) for each entitlement |
...
<RoutePill method="GET">/applications/[\{application.id\}](/docs/game-sdk/getting-started#get-set-up)/entitlements/[\{entitlement.id\}](/docs/game-sdk/store#entitlement-struct)</RoutePill>
...
| name          | type | description                                                                                                                    |
|---------------|------|--------------------------------------------------------------------------------------------------------------------------------|
| with_payment? | bool | returns [limited payment data](/docs/game-sdk/store#limited-payment-data-object) for each entitlement |
...
<RoutePill method="GET">/applications/[\{application.id\}](/docs/game-sdk/getting-started#get-set-up)/skus</RoutePill>
...
<RoutePill method="POST">/applications/[\{application.id\}](/docs/game-sdk/getting-started#get-set-up)/entitlements/[\{entitlement.id\}](/docs/game-sdk/store#entitlement-struct)/consume</RoutePill>
...
<RoutePill method="DELETE">/applications/[\{application.id\}](/docs/game-sdk/getting-started#get-set-up)/entitlements/[\{entitlement.id\}](/docs/game-sdk/store#entitlement-struct)</RoutePill>
...
<RoutePill method="PUT">/store/skus/[\{sku.id\}](/docs/game-sdk/store#sku-struct)/discounts/[\{user.id\}](/docs/resources/user#user-object)</RoutePill>
...
<RoutePill method="DELETE">/store/skus/[\{sku.id\}](/docs/game-sdk/store#sku-struct)/discounts/[\{user.id\}](/docs/resources/user#user-object)</RoutePill>
