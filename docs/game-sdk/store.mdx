...
<RoutePill method="GET">/applications/[\{application.id\}](/game-sdk/getting-started#get-set-up)/entitlements</RoutePill>
...
| with_payments? | bool                                     | returns [limited payment data](/game-sdk/store#limited-payment-data-object) for each entitlement |
...
| exclude_ended? | [bool](/reference#boolean-query-strings) | whether or not ended entitlements should be omitted                                              |
...
<RoutePill method="GET">/applications/[\{application.id\}](/game-sdk/getting-started#get-set-up)/entitlements/[\{entitlement.id\}](/game-sdk/store#entitlement-struct)</RoutePill>
...
| name          | type                                     | description                                                                                      |
|---------------|------------------------------------------|--------------------------------------------------------------------------------------------------|
| with_payment? | [bool](/reference#boolean-query-strings) | returns [limited payment data](/game-sdk/store#limited-payment-data-object) for each entitlement |
...
<RoutePill method="GET">/applications/[\{application.id\}](/game-sdk/getting-started#get-set-up)/skus</RoutePill>
...
<RoutePill method="POST">/applications/[\{application.id\}](/game-sdk/getting-started#get-set-up)/entitlements/[\{entitlement.id\}](/game-sdk/store#entitlement-struct)/consume</RoutePill>
...
<RoutePill method="DELETE">/applications/[\{application.id\}](/game-sdk/getting-started#get-set-up)/entitlements/[\{entitlement.id\}](/game-sdk/store#entitlement-struct)</RoutePill>
...
<RoutePill method="PUT">/store/skus/[\{sku.id\}](/game-sdk/store#sku-struct)/discounts/[\{user.id\}](/resources/user#user-object)</RoutePill>

Creates a discount for the given user on their next purchase of the given SKU. You should call this endpoint from your backend server just before calling [StartPurchase](/game-sdk/store#startpurchase) for the SKU you wish to discount. The user will then see a discounted price for that SKU at time of payment. The discount is automatically consumed after successful purchase or if the TTL expires.
...
<RoutePill method="DELETE">/store/skus/[\{sku.id\}](/game-sdk/store#sku-struct)/discounts/[\{user.id\}](/resources/user#user-object)</RoutePill>
