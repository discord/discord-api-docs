...
| name_localizations        | ?dictionary with keys as [available locales](/reference#locales) | Localization dictionary for the `name` field        |
| description               | string                                                           | Description of the achievement                      |
| description_localizations | ?dictionary with keys as [available locales](/reference#locales) | Localization dictionary for the `description` field |
...
| icon_hash                 | string                                                           | [Hash of the icon](/reference#image-formatting)     |
...
<RoutePill method="GET">/applications/[\{application.id\}](/game-sdk/getting-started#get-set-up)/achievements</RoutePill>
...
<RoutePill method="GET">/applications/[\{application.id\}](/game-sdk/getting-started#get-set-up)/achievements/[\{achievement.id\}](/game-sdk/achievements#achievement-struct)</RoutePill>
...
<RoutePill method="POST">/applications/[\{application.id\}](/game-sdk/getting-started#get-set-up)/achievements</RoutePill>
...
<RoutePill method="PATCH">/applications/[\{application.id\}](/game-sdk/getting-started#get-set-up)/achievements/[\{achievement.id\}](/game-sdk/achievements#achievement-struct)</RoutePill>
...
<RoutePill method="DELETE">/applications/[\{application.id\}](/game-sdk/getting-started#get-set-up)/achievements/[\{achievement.id\}](/game-sdk/achievements#achievement-struct)</RoutePill>
...
<RoutePill method="PUT">/users/[\{user.id\}](/resources/user#user-object)/applications/[\{application.id\}](/game-sdk/getting-started#get-set-up)/achievements/[\{achievement.id\}](/game-sdk/achievements#achievement-struct)</RoutePill>
...
<RoutePill method="GET">/users/@me/applications/[\{application.id\}](/game-sdk/getting-started#get-set-up)/achievements</RoutePill>

Returns a list of achievements for the user whose token you're making the request with. This endpoint will **NOT** accept the Bearer token for your application generated via the [Client Credentials Grant](/topics/oauth2#client-credentials-grant). You will need the _user's_ bearer token, gotten via either the [Authorization Code OAuth2 Grant](/topics/oauth2#authorization-code-grant) or via the SDK with [GetOAuth2Token](/game-sdk/applications#getoauth2token). This endpoint has a rate limit of 2 requests per 5 seconds per application per user.
