...
- [Discord GameSDK v3.2.1](https://dl-game-sdk.discordapp.net/3.2.1/discord_game-sdk.zip) - Latest version, includes Apple silicon (aarch64) support
- [Discord GameSDK v2.5.6](https://dl-game-sdk.discordapp.net/2.5.6/discord_game-sdk.zip) - Try this version if you encounter bugs on the latest version
...
/*
    ...
    "H:\\Unreal Projects\\gamesdktest\\Binaries\\Win64\\discord_game-sdk.dll.lib"
...
In your project settings, you'll want to include the relevant library (e.g. `discord_game-sdk.dll.lib`) as an additional dependency.
