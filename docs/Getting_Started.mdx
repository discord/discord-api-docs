...
<Collapsible
  title="Resources used in this guide"
  description="Overview of the tools and technologies we'll use"
  icon="list"
>
...
Bot tokens are used to authorize API requests and carry your bot user's permissions, making them _highly sensitive_. Make sure to _never_ share your token or check it into any kind of version control.
