...
<Collapsible
  title="Zasoby użyte w tym przewodniku"
  description="Podsumowanie narzędzi i technologii, których będziemy używać"
  icon="list"
>
  - **[Repozytorium GitHuba](https://github.com/discord/discord-example-app)**, gdzie znajdziesz kod z tego przewodnika
  wraz z dodatkowymi przykładami kodu przedstawiającymi określone funkcje. -
  **[discord-interactions](https://github.com/discord/discord-interactions-js)**, biblioteka zawierająca typy i
  pomocnicze funkcje do aplikacji Discorda. - **[Express](https://expressjs.com)**, popularny framework sieciowy
  JavaScript, którego użyjemy do utworzenia serwera, na który Discord może wysyłać żądania. -
  **[Glitch](https://glitch.com/)**, internetowe środowisko, które upraszcza projektowanie i hostowanie aplikacji na
  wczesnym etapie prototypu i rozwoju. Możesz też projektować aplikację lokalnie przy pomocy narzędzia takiego jak
...
Tokeny bota służą do uwierzytelniania żądań API i zawierają uprawnienia użytkownika bota, co czyni je _bardzo wrażliwymi_. _Nigdy_ nie udostępniaj swojego tokena ani nie umieszczaj go w systemie kontroli wersji.
