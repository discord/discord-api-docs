...
<Collapsible title="Cosa svilupperemo" icon="view">
Ecco l'aspetto dell'app finalizzata:

![Demo dell'app](getting-started-demo.gif)
...
<Collapsible title="Risorse utilizzate nella guida" description="Panoramica degli strumenti e tecnologie utilizzate" icon="list">
