...
![Error](social-sdk/getting-started/partials/error.webp)
...
![Settings](social-sdk/getting-started/partials/settings-security.webp)

Now when you get the pop up you'll have the option to select **Open Anyway** and it will be able to use it successfully.

![Open](social-sdk/getting-started/partials/open-anyway.webp)
