...
subpages:
 ...
 - development-guides/account-linking-on-mobile.mdx
...
<Container>
  ...
  <Card title="Account Linking on Mobile" link="/docs/discord-social-sdk/development-guides/account-linking-on-mobile" icon="MobilePhoneIcon">
