...
The badging logic in direct-messages is consistent with the logic detailed in the [Unified Friends List](/docs/discord-social-sdk/design-guidelines_UNIFIED_FRIENDS_LIST) section.
