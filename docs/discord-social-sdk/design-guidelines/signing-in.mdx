...
Discord's [Overlay](https://support.discord.com/hc/en-us/articles/217659737) feature can be used to enable authorization without ever leaving the game. This is available for games who support the feature.
