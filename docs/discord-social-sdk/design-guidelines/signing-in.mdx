...
[Home](#DOCS_INTRO) > [Discord Social SDK](#DOCS_DISCORD_SOCIAL_SDK_OVERVIEW) > [Design Guidelines](#DOCS_DISCORD_SOCIAL_SDK_DESIGN_GUIDELINES) > Signing In
...
Sign-in or log-in flows all begin with the interaction of a [**Discord-styled button**](#DOCS_DISCORD_SOCIAL_SDK_DESIGN_GUIDELINES_BRANDING_GUIDELINES/buttons).
...
![Overall Flow](social-sdk/design-guidelines/SigningIn-02.webp)

### Connecting your Discord account via Discord client (gif)

![Connecting your Discord account via Discord client](social-sdk/design-guidelines/animated/Connecting-via-Client.gif)

### Connecting your Discord account via Browser (gif)

![Connecting your Discord account via Browser](social-sdk/design-guidelines/animated/Connecting-via-Browser.gif)
...
![Overlay Authorization](social-sdk/design-guidelines/SigningIn-05.webp)
...
![Before the user connects](social-sdk/design-guidelines/SigningIn-06.webp)
...
![After the user connects](social-sdk/design-guidelines/SigningIn-07.webp)
...
![Error State](social-sdk/design-guidelines/SigningIn-08.webp)

---

## Resources 

- [Development Guide: Account Linking with Discord](#DOCS_DISCORD_SOCIAL_SDK_DEVELOPMENT_GUIDES_ACCOUNT_LINKING_WITH_DISCORD)
