---
sidebar_label: Account Linking on Mobile
---
...
- Set up your development environment with:
  ...
  - [Basic account linking flow](/docs/discord-social-sdk/development-guides/account-linking-with-discord) working
  on desktop
...
Please follow the [Unity Getting Started guide](/docs/discord-social-sdk/getting-started/using-unity) for general setup instructions. There are additional mobile-specific configurations you'll need to complete:
...
Please follow the [Unreal Engine Getting Started guide](/docs/discord-social-sdk/getting-started/using-unreal-engine) for general setup instructions. For mobile-specific configuration, you only need to configure your Discord Application ID in the project settings.
...
player's access token, which is covered under [Refreshing Access Tokens](/docs/discord-social-sdk/development-guides/account-linking-with-discord#refreshing-access-tokens).
