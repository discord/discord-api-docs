...
:::info
This guide covers general OAuth2 authentication. For **platform-specific requirements**, see:<br/>- [Account Linking on Consoles](/docs/discord-social-sdk/development-guides/account-linking-on-consoles)<br/>- [Account Linking on Mobile](/docs/discord-social-sdk/development-guides/account-linking-on-mobile)
:::
