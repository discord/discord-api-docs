...
- If the Discord client has [overlay support](https://support.discord.com/hc/en-us/articles/217659737) (Windows only), the OAuth2 login modal appears in your game instead of opening a browser.
