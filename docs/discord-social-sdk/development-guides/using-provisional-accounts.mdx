...
- A basic understanding of how the SDK works from the [Getting Started Guide](#DOCS_DISCORD_SOCIAL_SDK_GETTING_STARTED)
...
- Are created automatically for your players
...
When a player wants to unlink their Discord account from their provisional account, there are two options.
...
<Container>
 <Card title="Design: Provisional Accounts" link="#DOCS_DISCORD_SOCIAL_SDK_DESIGN_GUIDELINES_PROVISIONAL_ACCOUNTS" icon="PaintPaletteIcon">
