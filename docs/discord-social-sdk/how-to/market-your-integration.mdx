...
3. Stay connected
4. Keep the conversation going by syncing messages, friends lists, and game stats to Discord.
...
| **Deeplink Game Invites**         | Users can send invites that link directly to specific game instances or parts of a game                                                                                                                                                                                    | Challenging users to specific game instances<br/><br/>Linking to player stats or leaderboards                                                                                                                                                                                                                                                          |
...
* **Paid Media**
  * Run paid ads social to encourage people to link their Discord account.
* **Press**
  * Description: Pitch to relevant press outlets your story of the integration. For any press inquiries, please loop
...
* [Download Link](https://drive.google.com/drive/folders/1Md5VVpIFu3OTUN300YrWH_xIeoF-boPB?usp=drive_link)
