...
:::info
Our guidance focuses on features that encourage Discord account linking. It's the most important step for you and your players to experience the benefits of the integration. You can find more information about the impact of account linking [here](https://discord.com/developers/social-sdk). <br /><br /> If your announcements do not focus on Discord Social SDK features that require account linking, you can still generally use this guidance and our brand guidelines.
:::
