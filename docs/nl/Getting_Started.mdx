...
<Collapsible
  title="In deze gids gebruikte hulpbronnen"
  description="Overzicht van de tools en technologieën die we gebruiken"
  icon="list"
>
  - **[GitHub-register](https://github.com/discord/discord-example-app)** waar de code uit deze gids zich bevindt, samen
  met wat extra codevoorbeelden voor speciale functies. -
  **[discord-interacties](https://github.com/discord/discord-interactions-js)**, een bibliotheek met soort- en
  hulpfuncties voor Discord-apps. - **[Express](https://expressjs.com)**, een populair JavaScript-webframewerk dat we
  gebruiken om een server te creëren waarvandaan Discord ons verzoeken kan sturen. - **[Glitch](https://glitch.com/)**,
  een online omgeving die het bouwen en hosten van apps vereenvoudigt in de vroege prototype- en ontwikkelingsfase. Je
  kunt ook lokaal ontwikkelen met een tool als **[ngrok](https://ngrok.com/)**.
</Collapsible>
...
Met bottokens worden API-verzoeken geautoriseerd. Ze bevatten de machtigingen van je botgebruiker, waardoor ze _zeer kwetsbaar_ zijn. Deel _nooit_ je token en gebruik hem nooit bij versiecontrole.
