...
| [Radio Group](/docs/components/reference#radio-group-interaction-response-structure)                                  |
| [Checkbox Group](/docs/components/reference#checkbox-group-interaction-response-structure)                            |
| [Checkbox](/docs/components/reference#checkbox-interaction-response-structure)                                        |
...
| id?         | integer                                                                                 | Optional identifier for component                                        |
| custom_id   | string                                                                                  | Developer-defined identifier for the input; 1-100 characters             |
| options     | array of [radio group options](/docs/components/reference#radio-group-option-structure) | List of options to render; min 2, max 10                                 |
...
| id?         | integer                                                                                       | Optional identifier for component                                                             |
| custom_id   | string                                                                                        | Developer-defined identifier for the input; 1-100 characters                                  |
| options     | array of [checkbox group options](/docs/components/reference#checkbox-group-option-structure) | List of options to render; min 1, max 10                                                      |
