...
| 21   | [Radio Group](/docs/components/reference#radio-group)               | Single-choice set of options                                   | Interactive | Modal          |
| 22   | [Checkbox Group](/docs/components/reference#checkbox-group)         | Multi-selectable group of checkboxes                           | Interactive | Modal          |
| 23   | [Checkbox](/docs/components/reference#checkbox)                     | Single checkbox for yes/no choice                              | Interactive | Modal          |
...
| id?       | integer                                                                                             | Optional identifier for component                                        |
| custom_id | string                                                                                              | Developer-defined identifier for the input; 1-100 characters             |
| options   | array of [radio group options](/docs/components/reference#radio-group-radio-group-option-structure) | List of options to show; min 2, max 10                                   |
...
| id        | integer | Unique identifier for the component                                                                    |
| custom_id | string  | Developer-defined identifier for the input; 1-100 characters                                           |
| value     | ?string | The value of the selected option, or `null` if no option is selected (only possible when not required) |
...
<Collapsible title="Modal Example" description="Modal create payload with a Radio Group component" icon="code">
  ...
  <Collapsible title="Rendered Example" description="Visualization of the modal created by the payload below" icon="image" nested={true}>
    ![Example of a modal with a Radio Group](images/components/modal-radio-group.webp)
  </Collapsible>
...
| id?         | integer                                                                                                      | Optional identifier for component                                                                                 |
| custom_id   | string                                                                                                       | Developer-defined identifier for the input; 1-100 characters                                                      |
| options     | array of [checkbox group options](/docs/components/reference#checkbox-group-checkbox-group-option-structure) | List of options to show; min 1, max 10                                                                            |
...
<Collapsible title="Modal Example" description="Modal create payload with a Checkbox Group component" icon="code">
  ...
  <Collapsible title="Rendered Example" description="Visualization of the message created by the payload below" icon="image" nested={true}>
    ![Example of a modal with a Checkbox Group](images/components/modal-checkbox-group.webp)
  </Collapsible>
...
<Collapsible title="Modal Example" description="Modal create payload with a Checkbox component" icon="code">
  ...
  <Collapsible title="Rendered Example" description="Visualization of the message created by the payload below" icon="image" nested={true}>
    ![Example of a modal with a Checkbox](images/components/modal-checkbox.webp)
  </Collapsible>
