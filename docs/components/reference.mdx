...
| 21   | [Radio Group](/docs/components/reference#radio-group)               | Single-choice set of radio options                             | Interactive | Modal          |
| 22   | [Checkbox Group](/docs/components/reference#checkbox-group)         | Multi-select group of checkboxes                               | Interactive | Modal          |
| 23   | [Checkbox](/docs/components/reference#checkbox)                     | Single checkbox for binary choice                              | Interactive | Modal          |
...
| [Radio Group](/docs/components/reference#radio-group)               |
| [Checkbox Group](/docs/components/reference#checkbox-group)         |
| [Checkbox](/docs/components/reference#checkbox)                     |
...
| [Radio Group](/docs/components/reference#radio-group-radio-group-interaction-response-structure)                      |
| [Checkbox Group](/docs/components/reference#checkbox-group-checkbox-group-interaction-response-structure)             |
| [Checkbox](/docs/components/reference#checkbox-checkbox-interaction-response-structure)                               |
...
A Radio Group is an interactive component for selecting exactly one option from a defined list. Radio Groups are available in modals and must be placed inside a [Label](/docs/components/reference#label).
...
| id?       | integer                                                                                             | Optional identifier for component                                        |
| custom_id | string                                                                                              | Developer-defined identifier for the input; 1-100 characters             |
| options   | array of [radio group options](/docs/components/reference#radio-group-radio-group-option-structure) | List of options to render; min 2, max 10                                 |
...
<Collapsible title="Modal Example" description="Modal create payload with a Radio Group component" icon="code">

  <Collapsible title="Rendered Example" description="Visualization of the message created by the payload below" icon="image" nested={true}>
    ![Example of a modal with a Radio Group](images/components/radio-group-modal-example.webp)
  </Collapsible>
  ...
  ```json
  {
    "type": 9,
    "data": {
      "custom_id": "release_feedback_modal",
      ...
      "components": [
        {
          ...
          "component": {
            ...
            "options": [
              {"label": "Great", "value": "great", "default": true},
...
<Collapsible title="Modal Submit Interaction Data Example" description="When a user submits a modal containing a Radio Group" icon="code">
...
A Checkbox Group is an interactive component for selecting one or many options via checkboxes. Checkbox Groups are available in modals and must be placed inside a [Label](/docs/components/reference#label).
...
| id?         | integer                                                                                                      | Optional identifier for component                                                             |
| custom_id   | string                                                                                                       | Developer-defined identifier for the input; 1-100 characters                                  |
| options     | array of [checkbox group options](/docs/components/reference#checkbox-group-checkbox-group-option-structure) | List of options to render; min 1, max 10                                                      |
...
<Collapsible title="Modal Example" description="Modal create payload with a Checkbox Group component" icon="code">

  <Collapsible title="Rendered Example" description="Visualization of the message created by the payload below" icon="image" nested={true}>
    ![Example of a modal with a Checkbox Group](images/components/checkbox-group-modal-example.webp)
  </Collapsible>
  ...
  ```json
  {
    "type": 9,
    "data": {
      "custom_id": "improvements_modal",
      "title": "Improvement Areas",
      "components": [
        {
          "type": 18, // ComponentType.LABEL
          "label": "Which areas should we improve?",
          "component": {
            ...
            "options": [
              ...
              {"label": "UI", "value": "ui"},
              {"label": "Docs", "value": "docs", "default": true}
            ],
            "min_values": 1,
            "max_values": 3,
            "required": true
...
<Collapsible title="Modal Submit Interaction Data Example" description="When a user submits a modal containing a Checkbox Group" icon="code">

  ```json
  {
    "type": 5,
    "data": {
      "custom_id": "beta_preferences_modal",
      "components": [
        {
          "type": 18, // ComponentType.LABEL
          "component": {
...
A Checkbox is a single interactive component for simple yes/no style questions. Checkboxes are available in modals and must be placed inside a [Label](/docs/components/reference#label).
...
| id        | integer | Unique identifier for the component                          |
| custom_id | string  | Developer-defined identifier for the input; 1-100 characters |
| value     | boolean | The state of the checkbox                                    |

###### Examples

<Collapsible title="Modal Example" description="Modal create payload with a Checkbox component" icon="code">

  <Collapsible title="Rendered Example" description="Visualization of the message created by the payload below" icon="image" nested={true}>
    ![Example of a modal with a Checkbox](images/components/checkbox-modal-example.webp)
  </Collapsible>
...
<Collapsible title="Modal Submit Interaction Data Example" description="When a user submits a modal containing a Checkbox" icon="code">
