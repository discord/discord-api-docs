...
| 19   | [File Upload](/docs/components/reference#file-upload)               | Container associating a label and description with a component | Layout      | Modal          |
...
| required?   | boolean | Whether the file upload is required to be filled in a modal (defaults to `true`) |
...
<Collapsible title="Modal Example" description="Modal create payload with a File Upload component" icon="code">
  ...
  <Collapsible title="Rendered Example" description="Visualization of the modal created by the payload below" icon="image" nested={true}>
    ![A bug report modal with a File Upload for screenshots](images/components/modal-file-upload.webp)
  </Collapsible>
