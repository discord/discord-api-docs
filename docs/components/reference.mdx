...
File Upload is an interactive component that allows users to upload files in modals. File Uploads can be configured for both single-file and multi-file uploads.
