...
![Screenshot of the Teams page](images/team-page.webp)
...
![Screenshot of the create application modal with a Team selected](images/create-team-owned-app.webp)
...
![Screenshot of where to find the button to transfer an Application to a team](images/transfer-app-to-team.webp)
