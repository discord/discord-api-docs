...
For connections to the RPC server, an [allowlist](#DOCS_TOPICS_RPC/authorize) is used to restrict access while you're still developing. You can invite up to 50 people to your allowlist.
