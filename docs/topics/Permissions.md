...
| MANAGE_MESSAGES \*            | `0x0000000000002000` `(1 << 13)` | Allows crossposting other users' messages in news channels, deleting other users' messages and reactions and pinning messages                                                                                   | T            |
