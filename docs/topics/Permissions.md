...
| MODERATE_MEMBERS              | `1x0000000001` `(1 << 40)` | When you put a user in timeout they will not be able to send messages in chat, reply within threads, react to messages, or speak in voice or stage channels |              |
