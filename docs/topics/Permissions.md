...
| MANAGE_GUILD \*               | `0x0000000000000020` `(1 << 5)`  | Allows deleting invites, editing guild settings, guild welcome screen, and managing a guild's template, integrations (bots, webhooks, and app integrations), and the guild widget                             |              |
...
| MANAGE_MESSAGES \*            | `0x0000000000002000` `(1 << 13)` | Allows crossposting other users' messages in news channels, bypassing channel slowmodes, deleting other users' messages and reactions and pinning messages                                                                                   | T            |
...
| USE_EXTERNAL_EMOJIS           | `0x0000000000040000` `(1 << 18)` | Allows the usage of custom emojis from other guilds                                                                                                | T            |
...
| USE_EXTERNAL_STICKERS         | `0x0000002000000000` `(1 << 37)` | Allows the usage of custom stickers from other guilds                                                                                              | T            |
...
**\* These permissions require the owner account to use [two-factor authentication](#DOCS_TOPICS_OAUTH2/twofactor-authentication-requirement) when used on a guild that has guild-wide 2FA enabled.**
