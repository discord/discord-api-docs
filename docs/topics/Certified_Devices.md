...
3. Send us a [`SET_CERTIFIED_DEVICES`](/docs/topics/RPC#set_certified_devices) WebSocket payload or equivalent HTTP POST whenever the state of the device changes
...
|---------------------------|----------------------------------------------------------------------|----------------------------------------------------------|
| type                      | [device type](/docs/topics/Certified_Devices#device-type)     | the type of device                                       |
| id                        | string                                                               | the device's Windows UUID                                |
| vendor                    | [vendor](/docs/topics/Certified_Devices#vendor-object) object | the hardware vendor                                      |
| model                     | [model](/docs/topics/Certified_Devices#model-object) object   | the model of the product                                 |
