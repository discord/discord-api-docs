...
| applications.commands.permissions.update | allows your app to update its [command permissions](#DOCS_INTERACTIONS_APPLICATION_COMMANDS/permissions) via this bearer token                                                           |
