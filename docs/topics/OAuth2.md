...
Boom; fresh [access token response](#DOCS_TOPICS_OAUTH2/authorization-code-grant-access-token-response) with a new `access_token` and `refresh_token`!
