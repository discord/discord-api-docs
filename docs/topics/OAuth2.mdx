...
| activities.write                         | allows your app to update a user's activity - not currently available for apps (NOT REQUIRED FOR [GAMESDK ACTIVITY MANAGER](/docs/game-sdk/activities))                                |
...
4. Bots have an entirely separate set of [rate limits](/docs/topics/rate-limits).
