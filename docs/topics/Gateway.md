...
| members      | dict                                                               | a dictionary of thread ids to their respective [thread member](#DOCS_RESOURCES_CHANNEL/thread-member-object) objects from the synced threads for the current user, indicating which threads the current user has been added to |
