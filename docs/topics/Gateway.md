...
| sync_id?        | string                                                                        | the id of the song on Spotify                                                                                             |
| platform?       | string                                                                        | the platform the game is being played on ("desktop", "samsung", or "xbox")                                                |
...
| session_id?     | string                                                                        | the id of the game or Spotify session                                                                                     |
