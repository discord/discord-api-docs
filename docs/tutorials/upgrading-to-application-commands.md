...
![Client interfaces showing the different types of application commands](command-types.webp)
...
![Slash command using options](slash-command-options.webp)
...
![Interactions endpoint URL in app settings](interactions-url.webp)
...
![Example of ephemeral message to show search results](examples-ephemeral-message.webp)
...
![Example message updating users about a new feature](examples-update-message.webp)
