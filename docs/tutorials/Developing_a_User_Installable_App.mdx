...
Messages created in response to an interaction will include an [`interaction_metadata` object](#DOCS_RESOURCES_CHANNEL/message-interaction-metadata-object-message-interaction-metadata-structure) which includes metadata related to the interaction.
