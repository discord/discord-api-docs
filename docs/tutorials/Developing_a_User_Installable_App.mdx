...
> preview
> User-installed apps are currently in beta and subject to change. Learn details and limitations about the beta in the [change log entry](#DOCS_CHANGE_LOG_USERINSTALLABLE_APPS_PREVIEW)
