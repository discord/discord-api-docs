...
Go to the **Bot** page and find the **Privileged Gateway Intents** section. Toggle "Server Member Intent".
...
Before adding default install settings, we need to enable Discord provided links. We won't be covering custom URLs in this tutorial, but you can read more in [TODO: this nowhere to link rn lol]
