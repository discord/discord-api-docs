...
![Installation settings in App Settings](user-install-settings.webp)
...
![Sample game command response](user-install-game-message.webp)
...
Messages created in response to an interaction will include an [`interaction_metadata` object](#DOCS_RESOURCES_MESSAGE/message-interaction-metadata-object) which includes metadata related to the interaction.
